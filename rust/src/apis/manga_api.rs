...
/// struct for typed errors of method `chapters_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ChaptersFetchCollectionError {
...
/// struct for typed errors of method `chapters_fetch_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ChaptersFetchResourceError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `get_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchCollectionError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `get_fetch_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchResourceError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `trending_manga_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum TrendingMangaFetchCollectionError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
    ...
    pub async fn chapters_fetch_collection(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::ChaptersFetchCollectionresponse, Error<ChaptersFetchCollectionError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/chapters", configuration.base_path);
        ...
        if status.is_success() {
            ...
            let entity: Option<ChaptersFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn chapters_fetch_resource(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::ChaptersFetchResourceresponse, Error<ChaptersFetchResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/chapters/{id}", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<ChaptersFetchResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn get_fetch_collection(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchCollectionresponse1, Error<GetFetchCollectionError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/manga", configuration.base_path);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn get_fetch_resource(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchResourceresponse1, Error<GetFetchResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/manga/{id}", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn trending_manga_fetch_collection(configuration: &configuration::Configuration, ) -> Result<crate::models::TrendingMangaFetchCollectionresponse, Error<TrendingMangaFetchCollectionError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/trending/manga", configuration.base_path);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<TrendingMangaFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }
