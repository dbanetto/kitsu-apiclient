...
pub struct MangaApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> MangaApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> MangaApiClient<C> {
        MangaApiClient {
            configuration,
        }
    }
...
pub trait MangaApi {
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2009, Error = Error<serde_json::Value>>>;
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20039, Error = Error<serde_json::Value>>>;
}

impl<C: hyper::client::Connect>MangaApi for MangaApiClient<C> {
    fn fetch_collection(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/chapters".to_string())
        ;
    ...
    fn fetch_collection_0(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/manga".to_string())
        ;
    ...
    fn fetch_collection_1(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse20061, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/trending/manga".to_string())
        ;
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2009, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/chapters/{id}".to_string())
        ;
    ...
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20039, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/manga/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
