...
pub struct MediaRelationsApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> MediaRelationsApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> MediaRelationsApiClient<C> {
        MediaRelationsApiClient {
            configuration,
        }
    }
}

pub trait MediaRelationsApi {
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20016, Error = Error<serde_json::Value>>>;
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20029, Error = Error<serde_json::Value>>>;
    fn fetch_resource_1(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20040, Error = Error<serde_json::Value>>>;
    fn fetch_resource_2(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20046, Error = Error<serde_json::Value>>>;
}

impl<C: hyper::client::Connect>MediaRelationsApi for MediaRelationsApiClient<C> {
    fn fetch_collection(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/franchises".to_string())
        ;
    ...
    fn fetch_collection_0(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/installments".to_string())
        ;
    ...
    fn fetch_collection_1(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/mappings".to_string())
        ;
    ...
    fn fetch_collection_2(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/media-relationships".to_string())
        ;
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20016, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/franchises/{id}".to_string())
        ;
    ...
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20029, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/installments/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
    ...
    fn fetch_resource_1(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20040, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/mappings/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
    ...
    fn fetch_resource_2(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20046, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/media-relationships/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
