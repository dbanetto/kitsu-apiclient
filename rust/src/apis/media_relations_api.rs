...
/// struct for typed errors of method `franchises_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FranchisesFetchCollectionError {
...
/// struct for typed errors of method `franchises_fetch_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FranchisesFetchResourceError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `get_fetch_collection12`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchCollection12Error {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `get_fetch_resource12`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchResource12Error {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `installments_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum InstallmentsFetchCollectionError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `installments_fetch_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum InstallmentsFetchResourceError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `mappings_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MappingsFetchCollectionError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `mappings_fetch_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MappingsFetchResourceError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
    ...
    pub async fn franchises_fetch_collection(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FranchisesFetchCollectionresponse, Error<FranchisesFetchCollectionError>> {
        ...
        if status.is_success() {
            ...
            let entity: Option<FranchisesFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn franchises_fetch_resource(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FranchisesFetchResourceresponse, Error<FranchisesFetchResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/franchises/{id}", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<FranchisesFetchResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn get_fetch_collection12(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchCollectionresponse3, Error<GetFetchCollection12Error>> {
        let client = &configuration.client;

        let uri_str = format!("{}/media-relationships", configuration.base_path);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchCollection12Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn get_fetch_resource12(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchResourceresponse3, Error<GetFetchResource12Error>> {
        let client = &configuration.client;

        let uri_str = format!("{}/media-relationships/{id}", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchResource12Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn installments_fetch_collection(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::InstallmentsFetchCollectionresponse, Error<InstallmentsFetchCollectionError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/installments", configuration.base_path);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<InstallmentsFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn installments_fetch_resource(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::InstallmentsFetchResourceresponse, Error<InstallmentsFetchResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/installments/{id}", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<InstallmentsFetchResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn mappings_fetch_collection(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::MappingsFetchCollectionresponse, Error<MappingsFetchCollectionError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/mappings", configuration.base_path);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<MappingsFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn mappings_fetch_resource(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::MappingsFetchResourceresponse, Error<MappingsFetchResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/mappings/{id}", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<MappingsFetchResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }
