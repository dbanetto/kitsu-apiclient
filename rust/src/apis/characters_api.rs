...
pub struct CharactersApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> CharactersApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> CharactersApiClient<C> {
        CharactersApiClient {
            configuration,
        }
    }
...
pub trait CharactersApi {
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2001, Error = Error<serde_json::Value>>>;
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20010, Error = Error<serde_json::Value>>>;
    fn fetch_resource_1(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20037, Error = Error<serde_json::Value>>>;
...
impl<C: hyper::client::Connect>CharactersApi for CharactersApiClient<C> {
    fn create_resource(&self, ) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/anime-characters".to_string())
        ;
    ...
    fn create_resource_0(&self, ) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/characters".to_string())
        ;
        req = req.returns_nothing();
    ...
    fn create_resource_1(&self, ) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/manga-characters".to_string())
        ;
        req = req.returns_nothing();
    ...
    fn delete_resource(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Delete, "/anime-characters/{id}".to_string())
        ;
    ...
    fn delete_resource_0(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Delete, "/characters/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn delete_resource_1(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Delete, "/manga-characters/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn fetch_collection(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/anime-characters".to_string())
        ;
    ...
    fn fetch_collection_0(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/characters".to_string())
        ;
    ...
    fn fetch_collection_1(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/manga-characters".to_string())
        ;
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2001, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/anime-characters/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
    ...
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20010, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/characters/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
    ...
    fn fetch_resource_1(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20037, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/manga-characters/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
    ...
    fn update_resource(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Patch, "/anime-characters/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn update_resource_0(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Patch, "/characters/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn update_resource_1(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Patch, "/manga-characters/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
