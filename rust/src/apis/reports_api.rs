...
/// struct for typed errors of method `delete_resource12345678910`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteResource12345678910Error {
...
/// struct for typed errors of method `get_fetch_collection12345678910111213`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchCollection12345678910111213Error {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `get_fetch_resource12345678910111213`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchResource12345678910111213Error {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `patch_update_resource123456789`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PatchUpdateResource123456789Error {
    Status400(crate::models::Error406),
    Status401(crate::models::Error406),
...
/// struct for typed errors of method `post_create_resource123456789`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostCreateResource123456789Error {
    Status400(crate::models::Error406),
    Status401(crate::models::Error406),
    Status403(crate::models::Error406),
    Status404(crate::models::Error406),
    ...
    pub async fn delete_resource12345678910(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<DeleteResource12345678910Error>> {
        let client = &configuration.client;

        let uri_str = format!("{}/reports/{id}", configuration.base_path, id=id);
        ...
        if status.is_success() {
            ...
            let entity: Option<DeleteResource12345678910Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn get_fetch_collection12345678910111213(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchCollectionresponse14, Error<GetFetchCollection12345678910111213Error>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchCollection12345678910111213Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn get_fetch_resource12345678910111213(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchResourceresponse14, Error<GetFetchResource12345678910111213Error>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchResource12345678910111213Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn patch_update_resource123456789(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<PatchUpdateResource123456789Error>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<PatchUpdateResource123456789Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn post_create_resource123456789(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<PostCreateResource123456789Error>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<PostCreateResource123456789Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }
