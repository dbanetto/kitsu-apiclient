...
/// struct for typed errors of method `episodes_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum EpisodesFetchCollectionError {
...
/// struct for typed errors of method `episodes_fetch_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum EpisodesFetchResourceError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FetchCollectionError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `fetch_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method `trending_anime_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum TrendingAnimeFetchCollectionError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
    ...
    pub async fn episodes_fetch_collection(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::EpisodesFetchCollectionresponse, Error<EpisodesFetchCollectionError>> {
        ...
        if status.is_success() {
            ...
            let entity: Option<EpisodesFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn episodes_fetch_resource(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::EpisodesFetchResourceresponse, Error<EpisodesFetchResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/episodes/{id}", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<EpisodesFetchResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn fetch_collection(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchCollectionresponse, Error<FetchCollectionError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/anime", configuration.base_path);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<FetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn fetch_resource(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchResourceresponse, Error<FetchResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/anime/{id}", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<FetchResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn trending_anime_fetch_collection(configuration: &configuration::Configuration, ) -> Result<crate::models::TrendingAnimeFetchCollectionresponse, Error<TrendingAnimeFetchCollectionError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/trending/anime", configuration.base_path);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<TrendingAnimeFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }
