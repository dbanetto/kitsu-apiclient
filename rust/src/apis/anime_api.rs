...
pub struct AnimeApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> AnimeApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> AnimeApiClient<C> {
        AnimeApiClient {
            configuration,
        }
    }
...
pub trait AnimeApi {
    ...
    fn fetch_collection_1(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse20061, Error = Error<serde_json::Value>>>;
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2004, Error = Error<serde_json::Value>>>;
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20013, Error = Error<serde_json::Value>>>;
}

impl<C: hyper::client::Connect>AnimeApi for AnimeApiClient<C> {
    fn fetch_collection(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/anime".to_string())
        ;
    ...
    fn fetch_collection_0(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/episodes".to_string())
        ;
    ...
    fn fetch_collection_1(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse20061, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/trending/anime".to_string())
        ;
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2004, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/anime/{id}".to_string())
        ;
    ...
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20013, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/episodes/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
