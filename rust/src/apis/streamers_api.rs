...
pub struct StreamersApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> StreamersApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> StreamersApiClient<C> {
        StreamersApiClient {
            configuration,
        }
    }
...
pub trait StreamersApi {
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20059, Error = Error<serde_json::Value>>>;
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20060, Error = Error<serde_json::Value>>>;
}

impl<C: hyper::client::Connect>StreamersApi for StreamersApiClient<C> {
    fn fetch_collection(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/streamers".to_string())
        ;
    ...
    fn fetch_collection_0(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/streaming-links".to_string())
        ;
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20059, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/streamers/{id}".to_string())
        ;
    ...
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20060, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/streaming-links/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
