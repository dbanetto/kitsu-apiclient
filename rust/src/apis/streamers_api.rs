...
/// struct for typed errors of method `get_fetch_collection1234`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchCollection1234Error {
...
/// struct for typed errors of method `get_fetch_resource1234`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchResource1234Error {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `streaming_links_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum StreamingLinksFetchCollectionError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `streaming_links_fetch_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum StreamingLinksFetchResourceError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
    ...
    pub async fn get_fetch_collection1234(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchCollectionresponse5, Error<GetFetchCollection1234Error>> {
        let client = &configuration.client;

        let uri_str = format!("{}/streamers", configuration.base_path);
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchCollection1234Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn get_fetch_resource1234(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchResourceresponse5, Error<GetFetchResource1234Error>> {
        let client = &configuration.client;

        let uri_str = format!("{}/streamers/{id}", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchResource1234Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn streaming_links_fetch_collection(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::StreamingLinksFetchCollectionresponse, Error<StreamingLinksFetchCollectionError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/streaming-links", configuration.base_path);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<StreamingLinksFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn streaming_links_fetch_resource(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::StreamingLinksFetchResourceresponse, Error<StreamingLinksFetchResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/streaming-links/{id}", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<StreamingLinksFetchResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }
