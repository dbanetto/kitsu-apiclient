...
/// struct for typed errors of method `delete_resource1`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteResource1Error {
...
/// struct for typed errors of method `get_fetch_collection123`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchCollection123Error {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `get_fetch_resource123`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchResource123Error {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `media_attribute_votes_create_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MediaAttributeVotesCreateResourceError {
    Status400(crate::models::Error406),
    Status401(crate::models::Error406),
...
/// struct for typed errors of method `media_attribute_votes_delete_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MediaAttributeVotesDeleteResourceError {
    Status400(crate::models::Error406),
    Status401(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
...
/// struct for typed errors of method `media_attribute_votes_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MediaAttributeVotesFetchCollectionError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `media_attribute_votes_fetch_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MediaAttributeVotesFetchResourceError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `media_attribute_votes_update_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MediaAttributeVotesUpdateResourceError {
    Status400(crate::models::Error406),
    Status401(crate::models::Error406),
    Status403(crate::models::Error406),
    Status404(crate::models::Error406),
...
/// struct for typed errors of method `media_attributes_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MediaAttributesFetchCollectionError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `media_attributes_fetch_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MediaAttributesFetchResourceError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `patch_update_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PatchUpdateResourceError {
    Status400(crate::models::Error406),
    Status401(crate::models::Error406),
    Status403(crate::models::Error406),
    Status404(crate::models::Error406),
...
/// struct for typed errors of method `post_create_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostCreateResourceError {
    Status400(crate::models::Error406),
    Status401(crate::models::Error406),
    Status403(crate::models::Error406),
    Status404(crate::models::Error406),
    ...
    pub async fn delete_resource1(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<DeleteResource1Error>> {
        let client = &configuration.client;

        let uri_str = format!("{}/media-follows/{id}", configuration.base_path, id=id);
        ...
        if status.is_success() {
            ...
            let entity: Option<DeleteResource1Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn get_fetch_collection123(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchCollectionresponse4, Error<GetFetchCollection123Error>> {
        let client = &configuration.client;

        let uri_str = format!("{}/media-follows", configuration.base_path);
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchCollection123Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn get_fetch_resource123(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchResourceresponse4, Error<GetFetchResource123Error>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchResource123Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn media_attribute_votes_create_resource(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<MediaAttributeVotesCreateResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/media-attribute-votes", configuration.base_path);
        ...
        if status.is_success() {
            ...
            let entity: Option<MediaAttributeVotesCreateResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn media_attribute_votes_delete_resource(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<MediaAttributeVotesDeleteResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/media-attribute-votes/{id}", configuration.base_path, id=id);
        let mut req_builder = client.delete(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<MediaAttributeVotesDeleteResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn media_attribute_votes_fetch_collection(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::MediaAttributeVotesFetchCollectionresponse, Error<MediaAttributeVotesFetchCollectionError>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<MediaAttributeVotesFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn media_attribute_votes_fetch_resource(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::MediaAttributeVotesFetchResourceresponse, Error<MediaAttributeVotesFetchResourceError>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<MediaAttributeVotesFetchResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn media_attribute_votes_update_resource(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<MediaAttributeVotesUpdateResourceError>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<MediaAttributeVotesUpdateResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn media_attributes_fetch_collection(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::MediaAttributesFetchCollectionresponse, Error<MediaAttributesFetchCollectionError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/media-attributes", configuration.base_path);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<MediaAttributesFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn media_attributes_fetch_resource(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::MediaAttributesFetchResourceresponse, Error<MediaAttributesFetchResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/media-attributes/{id}", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<MediaAttributesFetchResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn patch_update_resource(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<PatchUpdateResourceError>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<PatchUpdateResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn post_create_resource(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<PostCreateResourceError>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<PostCreateResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }
