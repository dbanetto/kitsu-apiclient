...
/// struct for typed errors of method `comment_likes_create_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CommentLikesCreateResourceError {
...
/// struct for typed errors of method `comment_likes_delete_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CommentLikesDeleteResourceError {
    Status400(crate::models::Error406),
    Status401(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
...
/// struct for typed errors of method `comment_likes_fetch_collection`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CommentLikesFetchCollectionError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `comment_likes_fetch_resource`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CommentLikesFetchResourceError {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `delete_resource123456`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteResource123456Error {
    Status400(crate::models::Error406),
    Status401(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
...
/// struct for typed errors of method `get_fetch_collection123456789`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchCollection123456789Error {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `get_fetch_resource123456789`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFetchResource123456789Error {
    Status400(crate::models::Error406),
    Status404(crate::models::Error406),
    Status500(crate::models::Error406),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method `patch_update_resource12345`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PatchUpdateResource12345Error {
    Status400(crate::models::Error406),
    Status401(crate::models::Error406),
    Status403(crate::models::Error406),
    Status404(crate::models::Error406),
...
/// struct for typed errors of method `post_create_resource12345`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostCreateResource12345Error {
    Status400(crate::models::Error406),
    Status401(crate::models::Error406),
    Status403(crate::models::Error406),
    Status404(crate::models::Error406),
    ...
    pub async fn comment_likes_create_resource(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<CommentLikesCreateResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/comment-likes", configuration.base_path);
        ...
        if status.is_success() {
            ...
            let entity: Option<CommentLikesCreateResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn comment_likes_delete_resource(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<CommentLikesDeleteResourceError>> {
        let client = &configuration.client;

        let uri_str = format!("{}/comment-likes/{id}", configuration.base_path, id=id);
        ...
        if status.is_success() {
            ...
            let entity: Option<CommentLikesDeleteResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn comment_likes_fetch_collection(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::CommentLikesFetchCollectionresponse, Error<CommentLikesFetchCollectionError>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<CommentLikesFetchCollectionError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn comment_likes_fetch_resource(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::CommentLikesFetchResourceresponse, Error<CommentLikesFetchResourceError>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<CommentLikesFetchResourceError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn delete_resource123456(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<DeleteResource123456Error>> {
        let client = &configuration.client;

        let uri_str = format!("{}/comments/{id}", configuration.base_path, id=id);
        let mut req_builder = client.delete(uri_str.as_str());
        ...
        if status.is_success() {
            ...
            let entity: Option<DeleteResource123456Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn get_fetch_collection123456789(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchCollectionresponse10, Error<GetFetchCollection123456789Error>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchCollection123456789Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn get_fetch_resource123456789(configuration: &configuration::Configuration, id: f64) -> Result<crate::models::FetchResourceresponse10, Error<GetFetchResource123456789Error>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<GetFetchResource123456789Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn patch_update_resource12345(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<PatchUpdateResource12345Error>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<PatchUpdateResource12345Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }

    pub async fn post_create_resource12345(configuration: &configuration::Configuration, id: f64, content_type: &str) -> Result<(), Error<PostCreateResource12345Error>> {
        let client = &configuration.client;
        ...
        if status.is_success() {
            ...
            let entity: Option<PostCreateResource12345Error> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }
