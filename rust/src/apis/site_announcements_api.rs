...
pub struct SiteAnnouncementsApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> SiteAnnouncementsApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> SiteAnnouncementsApiClient<C> {
        SiteAnnouncementsApiClient {
            configuration,
        }
    }
}

pub trait SiteAnnouncementsApi {
    fn fetch_collection(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>>;
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20057, Error = Error<serde_json::Value>>>;
}

impl<C: hyper::client::Connect>SiteAnnouncementsApi for SiteAnnouncementsApiClient<C> {
    fn fetch_collection(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/site-announcements".to_string())
        ;
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20057, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/site-announcements/{id}".to_string())
        ;
