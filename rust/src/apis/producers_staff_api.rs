...
pub struct ProducersStaffApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> ProducersStaffApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> ProducersStaffApiClient<C> {
        ProducersStaffApiClient {
            configuration,
        }
    }
}

pub trait ProducersStaffApi {
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2002, Error = Error<serde_json::Value>>>;
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2003, Error = Error<serde_json::Value>>>;
    fn fetch_resource_1(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2006, Error = Error<serde_json::Value>>>;
    fn fetch_resource_2(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20038, Error = Error<serde_json::Value>>>;
    fn fetch_resource_3(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20047, Error = Error<serde_json::Value>>>;
    fn fetch_resource_4(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20050, Error = Error<serde_json::Value>>>;
...
impl<C: hyper::client::Connect>ProducersStaffApi for ProducersStaffApiClient<C> {
    fn create_resource(&self, ) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/anime-productions".to_string())
        ;
    ...
    fn create_resource_0(&self, ) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/anime-staff".to_string())
        ;
        req = req.returns_nothing();
    ...
    fn create_resource_1(&self, ) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/castings".to_string())
        ;
        req = req.returns_nothing();
    ...
    fn create_resource_2(&self, ) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/manga-staff".to_string())
        ;
        req = req.returns_nothing();
    ...
    fn create_resource_3(&self, ) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/people".to_string())
        ;
        req = req.returns_nothing();
    ...
    fn create_resource_4(&self, ) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/producers".to_string())
        ;
        req = req.returns_nothing();
    ...
    fn delete_resource(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Delete, "/anime-productions/{id}".to_string())
        ;
    ...
    fn delete_resource_0(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Delete, "/anime-staff/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn delete_resource_1(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Delete, "/castings/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn delete_resource_2(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Delete, "/manga-staff/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn delete_resource_3(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Delete, "/people/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn delete_resource_4(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Delete, "/producers/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn fetch_collection(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/anime-productions".to_string())
        ;
    ...
    fn fetch_collection_0(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/anime-staff".to_string())
        ;
    ...
    fn fetch_collection_1(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/castings".to_string())
        ;
    ...
    fn fetch_collection_2(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/manga-staff".to_string())
        ;
    ...
    fn fetch_collection_3(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/people".to_string())
        ;
    ...
    fn fetch_collection_4(&self, ) -> Box<dyn Future<Item = crate::models::InlineResponse200, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/producers".to_string())
        ;
    ...
    fn fetch_resource(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2002, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/anime-productions/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
    ...
    fn fetch_resource_0(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2003, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/anime-staff/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
    ...
    fn fetch_resource_1(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse2006, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/castings/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
    ...
    fn fetch_resource_2(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20038, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/manga-staff/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
    ...
    fn fetch_resource_3(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20047, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/people/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
    ...
    fn fetch_resource_4(&self, id: f32) -> Box<dyn Future<Item = crate::models::InlineResponse20050, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/producers/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
    ...
    fn update_resource(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Patch, "/anime-productions/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn update_resource_0(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Patch, "/anime-staff/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn update_resource_1(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Patch, "/castings/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn update_resource_2(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Patch, "/manga-staff/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn update_resource_3(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Patch, "/people/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
    ...
    fn update_resource_4(&self, id: f32) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Patch, "/producers/{id}".to_string())
        ;
        req = req.with_path_param("id".to_string(), id.to_string());
        req = req.returns_nothing();
