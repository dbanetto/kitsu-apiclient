...
pub struct CastingsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Castings>,
    #[serde(rename = "meta")]
...
impl CastingsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Castings>, meta: crate::models::Meta14) -> CastingsFetchCollectionresponse {
        CastingsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
