...
pub struct InlineResponse20045DataAttributes {
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "reaction", skip_serializing_if = "Option::is_none")]
    pub reaction: Option<String>,
    #[serde(rename = "upVotesCount", skip_serializing_if = "Option::is_none")]
    pub up_votes_count: Option<f32>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl InlineResponse20045DataAttributes {
    pub fn new() -> InlineResponse20045DataAttributes {
        InlineResponse20045DataAttributes {
            created_at: None,
            reaction: None,
            up_votes_count: None,
            updated_at: None,
