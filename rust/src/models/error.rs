...
/// Error : Error objects provide additional information about errors encountered while performing an operation. See [JSON API/#error-objects](http://jsonapi.org/format/#error-objects)



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Error {
    /// a short, human-readable summary of the error. It SHOULD NOT change from occurence to occurenace
    ...
    /// a HTTP status code ([RFC2616](https://tools.ietf.org/html/rfc2616#section-6), Section 6) generated by the origin server
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "source", skip_serializing_if = "Option::is_none")]
    pub source: Option<crate::models::Source2>,
}

impl Error {
    /// Error objects provide additional information about errors encountered while performing an operation. See [JSON API/#error-objects](http://jsonapi.org/format/#error-objects)
    pub fn new() -> Error {
        Error {
            title: None,
            detail: None,
