...
pub struct InlineResponse2002DataAttributes {
...
impl InlineResponse2002DataAttributes {
    pub fn new() -> InlineResponse2002DataAttributes {
        InlineResponse2002DataAttributes {
            created_at: None,
            role: None,
            updated_at: None,
        }
