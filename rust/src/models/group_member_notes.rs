...
pub struct GroupMemberNotes {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::GroupMemberNotesAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl GroupMemberNotes {
    pub fn new(id: String, _type: String) -> GroupMemberNotes {
        GroupMemberNotes {
            attributes: None,
            id,
            links: None,
