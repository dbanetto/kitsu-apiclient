...
pub struct InlineResponse20042DataRelationships {
...
impl InlineResponse20042DataRelationships {
    pub fn new() -> InlineResponse20042DataRelationships {
        InlineResponse20042DataRelationships {
            anime: None,
            drama: None,
            manga: None,
        }
