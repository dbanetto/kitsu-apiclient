...
pub struct InlineResponse20031MetaStatusCounts {
    ...
    pub dropped: Option<f32>,
    #[serde(rename = "onHold", skip_serializing_if = "Option::is_none")]
    pub on_hold: Option<f32>,
    #[serde(rename = "planned", skip_serializing_if = "Option::is_none")]
    pub planned: Option<f32>,
}

impl InlineResponse20031MetaStatusCounts {
    pub fn new() -> InlineResponse20031MetaStatusCounts {
        InlineResponse20031MetaStatusCounts {
            completed: None,
            current: None,
            dropped: None,
            on_hold: None,
