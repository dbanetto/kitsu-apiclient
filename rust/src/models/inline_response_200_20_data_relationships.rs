...
pub struct InlineResponse20020DataRelationships {
    #[serde(rename = "group", skip_serializing_if = "Option::is_none")]
    pub group: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "sender", skip_serializing_if = "Option::is_none")]
    pub sender: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse20020DataRelationships {
    pub fn new() -> InlineResponse20020DataRelationships {
        InlineResponse20020DataRelationships {
            group: None,
            sender: None,
            user: None,
        }
