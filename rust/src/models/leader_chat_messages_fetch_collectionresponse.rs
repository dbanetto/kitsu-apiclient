...
pub struct LeaderChatMessagesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::LeaderChatMessages>,
    #[serde(rename = "meta")]
...
impl LeaderChatMessagesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::LeaderChatMessages>, meta: crate::models::Meta14) -> LeaderChatMessagesFetchCollectionresponse {
        LeaderChatMessagesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
