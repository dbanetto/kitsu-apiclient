...
pub struct InlineResponse20048Data {
    ...
    pub relationships: Option<crate::models::InlineResponse20048DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl InlineResponse20048Data {
    pub fn new(id: String, _type: String) -> InlineResponse20048Data {
