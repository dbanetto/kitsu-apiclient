...
pub struct PeopleFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::People>,
    #[serde(rename = "meta")]
...
impl PeopleFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::People>, meta: crate::models::Meta14) -> PeopleFetchCollectionresponse {
        PeopleFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
