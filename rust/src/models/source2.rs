...
/// Source2 : an object containing references to the source of the error



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Source2 {
    /// a JSON Pointer [RFC6901](https://tools.ietf.org/html/rfc6901) to the associated entity in the request
