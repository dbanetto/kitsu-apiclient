...
pub struct InlineResponse2001DataAttributes {
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    /// Role the character plays in the anime
...
impl InlineResponse2001DataAttributes {
    pub fn new() -> InlineResponse2001DataAttributes {
