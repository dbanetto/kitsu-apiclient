...
pub struct FetchCollectionresponse3 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::MediaRelationships>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse3 {
    pub fn new(data: Vec<crate::models::MediaRelationships>, meta: crate::models::Meta14) -> FetchCollectionresponse3 {
