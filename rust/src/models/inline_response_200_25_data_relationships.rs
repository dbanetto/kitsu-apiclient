...
pub struct InlineResponse20025DataRelationships {
    ...
    pub moderator: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "naughty", skip_serializing_if = "Option::is_none")]
    pub naughty: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse20025DataRelationships {
    pub fn new() -> InlineResponse20025DataRelationships {
        InlineResponse20025DataRelationships {
            group: None,
            moderator: None,
            naughty: None,
            user: None,
