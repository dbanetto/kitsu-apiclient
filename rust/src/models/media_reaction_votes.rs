...
pub struct MediaReactionVotes {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::MediaReactionVotesAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl MediaReactionVotes {
    pub fn new(id: String, _type: String) -> MediaReactionVotes {
        MediaReactionVotes {
            attributes: None,
            id,
            links: None,
