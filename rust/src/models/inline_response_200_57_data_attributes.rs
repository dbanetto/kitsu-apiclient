...
pub struct InlineResponse20057DataAttributes {
...
impl InlineResponse20057DataAttributes {
    pub fn new() -> InlineResponse20057DataAttributes {
        InlineResponse20057DataAttributes {
            created_at: None,
            description: None,
            image_url: None,
            link: None,
