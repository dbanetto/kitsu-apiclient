...
pub struct InlineResponse20051DataAttributes {
...
impl InlineResponse20051DataAttributes {
    pub fn new() -> InlineResponse20051DataAttributes {
        InlineResponse20051DataAttributes {
            created_at: None,
            name: None,
            updated_at: None,
        }
