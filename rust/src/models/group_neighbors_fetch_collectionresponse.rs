...
pub struct GroupNeighborsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::GroupNeighbors>,
    #[serde(rename = "meta")]
...
impl GroupNeighborsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::GroupNeighbors>, meta: crate::models::Meta14) -> GroupNeighborsFetchCollectionresponse {
        GroupNeighborsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
