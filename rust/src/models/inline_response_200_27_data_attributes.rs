...
pub struct InlineResponse20027DataAttributes {
...
impl InlineResponse20027DataAttributes {
    pub fn new() -> InlineResponse20027DataAttributes {
        InlineResponse20027DataAttributes {
            created_at: None,
            status: None,
            updated_at: None,
        }
