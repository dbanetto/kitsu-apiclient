...
/// AnimeAttributesTitles : Titles in different languages. Other languages will be listed if they exist.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AnimeAttributesTitles {
...
impl AnimeAttributesTitles {
    /// Titles in different languages. Other languages will be listed if they exist.
    pub fn new() -> AnimeAttributesTitles {
        AnimeAttributesTitles {
            en: None,
            en_jp: None,
            ja_jp: None,
        }
