...
pub struct InlineResponse20026DataAttributes {
...
impl InlineResponse20026DataAttributes {
    pub fn new() -> InlineResponse20026DataAttributes {
        InlineResponse20026DataAttributes {
            content: None,
            created_at: None,
            kind: None,
            updated_at: None,
