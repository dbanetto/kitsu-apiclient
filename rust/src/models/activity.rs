...
pub struct Activity {
    ...
    #[serde(rename = "anime_id", skip_serializing_if = "Option::is_none")]
    pub anime_id: Option<f32>,
    #[serde(rename = "drama_id", skip_serializing_if = "Option::is_none")]
    pub drama_id: Option<f32>,
    #[serde(rename = "manga_id", skip_serializing_if = "Option::is_none")]
    pub manga_id: Option<f32>,
    #[serde(rename = "created_at", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "updated_at", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
    #[serde(rename = "changed_data", skip_serializing_if = "Option::is_none")]
    pub changed_data: Option<crate::models::ChangedData>,
    #[serde(rename = "library_entry_id", skip_serializing_if = "Option::is_none")]
    pub library_entry_id: Option<f32>,
}
