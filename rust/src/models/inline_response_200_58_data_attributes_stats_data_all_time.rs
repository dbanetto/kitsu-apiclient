...
/// InlineResponse20058DataAttributesStatsDataAllTime : Omitted if not **amount-consumed** kind



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse20058DataAttributesStatsDataAllTime {
    #[serde(rename = "total_media", skip_serializing_if = "Option::is_none")]
    pub total_media: Option<f32>,
    /// Total chapters or episodes
    #[serde(rename = "total_progress", skip_serializing_if = "Option::is_none")]
...
impl InlineResponse20058DataAttributesStatsDataAllTime {
    /// Omitted if not **amount-consumed** kind
    pub fn new() -> InlineResponse20058DataAttributesStatsDataAllTime {
        InlineResponse20058DataAttributesStatsDataAllTime {
            total_media: None,
            total_progress: None,
            total_time: None,
        }
