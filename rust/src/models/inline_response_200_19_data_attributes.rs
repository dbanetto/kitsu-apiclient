...
pub struct InlineResponse20019DataAttributes {
...
impl InlineResponse20019DataAttributes {
    pub fn new() -> InlineResponse20019DataAttributes {
        InlineResponse20019DataAttributes {
            created_at: None,
            description: None,
            name: None,
            slug: None,
