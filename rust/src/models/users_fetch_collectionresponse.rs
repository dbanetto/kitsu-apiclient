...
pub struct UsersFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Users>,
    #[serde(rename = "meta")]
...
impl UsersFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Users>, meta: crate::models::Meta14) -> UsersFetchCollectionresponse {
        UsersFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
