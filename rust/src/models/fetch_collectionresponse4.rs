...
pub struct FetchCollectionresponse4 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::MediaFollows>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse4 {
    pub fn new(data: Vec<crate::models::MediaFollows>, meta: crate::models::Meta14) -> FetchCollectionresponse4 {
