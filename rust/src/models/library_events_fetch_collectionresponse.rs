...
pub struct LibraryEventsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::LibraryEvents>,
    #[serde(rename = "meta")]
...
impl LibraryEventsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::LibraryEvents>, meta: crate::models::Meta14) -> LibraryEventsFetchCollectionresponse {
        LibraryEventsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
