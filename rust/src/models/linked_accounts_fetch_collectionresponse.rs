...
pub struct LinkedAccountsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::LinkedAccounts>,
    #[serde(rename = "meta")]
...
impl LinkedAccountsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::LinkedAccounts>, meta: crate::models::Meta14) -> LinkedAccountsFetchCollectionresponse {
        LinkedAccountsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
