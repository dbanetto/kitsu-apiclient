...
pub struct ProfileLinkSitesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::ProfileLinkSites>,
    #[serde(rename = "meta")]
...
impl ProfileLinkSitesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::ProfileLinkSites>, meta: crate::models::Meta14) -> ProfileLinkSitesFetchCollectionresponse {
        ProfileLinkSitesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
