...
pub struct PostFollowsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::PostFollows>,
    #[serde(rename = "meta")]
...
impl PostFollowsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::PostFollows>, meta: crate::models::Meta14) -> PostFollowsFetchCollectionresponse {
        PostFollowsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
