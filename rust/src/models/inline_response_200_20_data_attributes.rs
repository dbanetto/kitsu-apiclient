...
pub struct InlineResponse20020DataAttributes {
    #[serde(rename = "acceptedAt", skip_serializing_if = "Option::is_none")]
    pub accepted_at: Option<String>,
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "declinedAt", skip_serializing_if = "Option::is_none")]
...
impl InlineResponse20020DataAttributes {
    pub fn new() -> InlineResponse20020DataAttributes {
        InlineResponse20020DataAttributes {
            accepted_at: None,
            created_at: None,
            declined_at: None,
            revoked_at: None,
