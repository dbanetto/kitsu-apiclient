...
pub struct MediaRelationships {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::MediaRelationshipsAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl MediaRelationships {
    pub fn new(id: String, _type: String) -> MediaRelationships {
        MediaRelationships {
            attributes: None,
            id,
            links: None,
