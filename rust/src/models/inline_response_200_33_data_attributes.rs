...
pub struct InlineResponse20033DataAttributes {
    #[serde(rename = "actionPerformed", skip_serializing_if = "Option::is_none")]
    pub action_performed: Option<ActionPerformed>,
...
impl InlineResponse20033DataAttributes {
    pub fn new() -> InlineResponse20033DataAttributes {
        InlineResponse20033DataAttributes {
