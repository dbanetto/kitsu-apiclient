...
pub struct InstallmentsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Installments>,
    #[serde(rename = "meta")]
...
impl InstallmentsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Installments>, meta: crate::models::Meta14) -> InstallmentsFetchCollectionresponse {
        InstallmentsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
