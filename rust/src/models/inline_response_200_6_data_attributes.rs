...
pub struct InlineResponse2006DataAttributes {
    ...
    pub voice_actor: Option<bool>,
}

impl InlineResponse2006DataAttributes {
    pub fn new() -> InlineResponse2006DataAttributes {
