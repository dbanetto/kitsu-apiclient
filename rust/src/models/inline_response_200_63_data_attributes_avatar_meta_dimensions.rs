...
pub struct InlineResponse20063DataAttributesAvatarMetaDimensions {
    #[serde(rename = "large", skip_serializing_if = "Option::is_none")]
    pub large: Option<crate::models::InlineResponse20063DataAttributesAvatarMetaDimensionsLarge>,
    #[serde(rename = "medium", skip_serializing_if = "Option::is_none")]
    pub medium: Option<crate::models::InlineResponse20063DataAttributesAvatarMetaDimensionsLarge>,
    #[serde(rename = "small", skip_serializing_if = "Option::is_none")]
    pub small: Option<crate::models::InlineResponse20063DataAttributesAvatarMetaDimensionsSmall>,
    #[serde(rename = "tiny", skip_serializing_if = "Option::is_none")]
    pub tiny: Option<crate::models::InlineResponse20063DataAttributesAvatarMetaDimensionsLarge>,
}

impl InlineResponse20063DataAttributesAvatarMetaDimensions {
    pub fn new() -> InlineResponse20063DataAttributesAvatarMetaDimensions {
        InlineResponse20063DataAttributesAvatarMetaDimensions {
            large: None,
            medium: None,
            small: None,
            tiny: None,
