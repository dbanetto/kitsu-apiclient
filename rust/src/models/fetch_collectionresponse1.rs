...
pub struct FetchCollectionresponse1 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Manga>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse1 {
    pub fn new(data: Vec<crate::models::Manga>, meta: crate::models::Meta14) -> FetchCollectionresponse1 {
