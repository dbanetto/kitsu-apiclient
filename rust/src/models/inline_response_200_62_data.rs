...
pub struct InlineResponse20062Data {
    ...
    pub relationships: Option<crate::models::InlineResponse20062DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl InlineResponse20062Data {
    pub fn new(id: String, _type: String) -> InlineResponse20062Data {
