...
pub struct InlineResponse20035DataAttributes {
    ...
    #[serde(rename = "shareFrom", skip_serializing_if = "Option::is_none")]
    pub share_from: Option<bool>,
    #[serde(rename = "shareTo", skip_serializing_if = "Option::is_none")]
    pub share_to: Option<bool>,
    #[serde(rename = "syncTo", skip_serializing_if = "Option::is_none")]
    pub sync_to: Option<bool>,
    #[serde(rename = "token", skip_serializing_if = "Option::is_none")]
    pub token: Option<crate::models::InlineResponse20035DataAttributesToken>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl InlineResponse20035DataAttributes {
    pub fn new() -> InlineResponse20035DataAttributes {
        InlineResponse20035DataAttributes {
            created_at: None,
