...
pub struct PostLikesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::PostLikes>,
    #[serde(rename = "meta")]
...
impl PostLikesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::PostLikes>, meta: crate::models::Meta14) -> PostLikesFetchCollectionresponse {
        PostLikesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
