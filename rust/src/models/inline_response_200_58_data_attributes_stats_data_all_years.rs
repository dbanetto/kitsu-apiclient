...
/// InlineResponse20058DataAttributesStatsDataAllYears : Omitted if not **favorite-year** kind



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse20058DataAttributesStatsDataAllYears {
    #[serde(rename = "2004", skip_serializing_if = "Option::is_none")]
    pub var_2004: Option<f32>,
    #[serde(rename = "2013", skip_serializing_if = "Option::is_none")]
    pub var_2013: Option<f32>,
    #[serde(rename = "2016", skip_serializing_if = "Option::is_none")]
    pub var_2016: Option<f32>,
    #[serde(rename = "2017", skip_serializing_if = "Option::is_none")]
    pub var_2017: Option<f32>,
    #[serde(rename = "2018", skip_serializing_if = "Option::is_none")]
    pub var_2018: Option<f32>,
}

impl InlineResponse20058DataAttributesStatsDataAllYears {
    /// Omitted if not **favorite-year** kind
    pub fn new() -> InlineResponse20058DataAttributesStatsDataAllYears {
        InlineResponse20058DataAttributesStatsDataAllYears {
            var_2004: None,
            var_2013: None,
            var_2016: None,
            var_2017: None,
