...
pub struct InlineResponse20058DataAttributes {
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "kind", skip_serializing_if = "Option::is_none")]
    pub kind: Option<Kind>,
    #[serde(rename = "statsData", skip_serializing_if = "Option::is_none")]
    pub stats_data: Option<crate::models::InlineResponse20058DataAttributesStatsData>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl InlineResponse20058DataAttributes {
    pub fn new() -> InlineResponse20058DataAttributes {
        InlineResponse20058DataAttributes {
            created_at: None,
            kind: None,
            stats_data: None,
            updated_at: None,
...
pub enum Kind {
    #[serde(rename = "anime-activity-history")]
    AnimeActivityHistory,
    #[serde(rename = "anime-amount-consumed")]
    AnimeAmountConsumed,
    #[serde(rename = "anime-category-breakdown")]
    AnimeCategoryBreakdown,
    #[serde(rename = "anime-favorite-year")]
    AnimeFavoriteYear,
    #[serde(rename = "manga-activity-history")]
    MangaActivityHistory,
    #[serde(rename = "manga-amount-consumed")]
    MangaAmountConsumed,
    #[serde(rename = "manga-category-breakdown")]
    MangaCategoryBreakdown,
    #[serde(rename = "manga-favorite-year")]
    MangaFavoriteYear,
}
