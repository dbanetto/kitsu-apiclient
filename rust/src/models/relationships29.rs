...
pub struct Relationships29 {
    ...
    pub chapters: Option<crate::models::Chapters1>,
    #[serde(rename = "mangaCharacters", skip_serializing_if = "Option::is_none")]
    pub manga_characters: Option<crate::models::MangaCharacters1>,
    #[serde(rename = "mangaStaff", skip_serializing_if = "Option::is_none")]
    pub manga_staff: Option<crate::models::MangaStaff1>,
}

impl Relationships29 {
    pub fn new() -> Relationships29 {
        Relationships29 {
            genres: None,
            categories: None,
            castings: None,
