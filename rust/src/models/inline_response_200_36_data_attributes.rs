...
pub struct InlineResponse20036DataAttributes {
    ...
    pub input_file: Option<crate::models::InlineResponse2009DataAttributesThumbnail>,
...
impl InlineResponse20036DataAttributes {
    pub fn new() -> InlineResponse20036DataAttributes {
        InlineResponse20036DataAttributes {
            created_at: None,
            error_message: None,
            error_trace: None,
            input_file: None,
