...
pub struct GroupActionLogs {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::GroupActionLogsAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl GroupActionLogs {
    pub fn new(id: String, _type: String) -> GroupActionLogs {
        GroupActionLogs {
            attributes: None,
            id,
            links: None,
