...
pub struct InlineResponse20046Data {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::InlineResponse20046DataAttributes>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<crate::models::InlineResponse2001DataLinks>,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<crate::models::InlineResponse20023DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl InlineResponse20046Data {
    pub fn new(id: String, _type: String) -> InlineResponse20046Data {
