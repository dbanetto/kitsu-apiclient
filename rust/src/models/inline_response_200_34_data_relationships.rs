...
pub struct InlineResponse20034DataRelationships {
...
impl InlineResponse20034DataRelationships {
    pub fn new() -> InlineResponse20034DataRelationships {
        InlineResponse20034DataRelationships {
            anime: None,
            drama: None,
            library_entry: None,
            manga: None,
