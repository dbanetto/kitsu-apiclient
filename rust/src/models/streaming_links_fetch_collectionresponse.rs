...
pub struct StreamingLinksFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::StreamingLinks>,
    #[serde(rename = "meta")]
...
impl StreamingLinksFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::StreamingLinks>, meta: crate::models::Meta14) -> StreamingLinksFetchCollectionresponse {
        StreamingLinksFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
