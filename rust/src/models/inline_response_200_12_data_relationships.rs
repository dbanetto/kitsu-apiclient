...
pub struct InlineResponse20012DataRelationships {
    #[serde(rename = "likes", skip_serializing_if = "Option::is_none")]
    pub likes: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "parent", skip_serializing_if = "Option::is_none")]
    pub parent: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "post", skip_serializing_if = "Option::is_none")]
    pub post: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "replies", skip_serializing_if = "Option::is_none")]
    pub replies: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
...
impl InlineResponse20012DataRelationships {
    pub fn new() -> InlineResponse20012DataRelationships {
        InlineResponse20012DataRelationships {
            likes: None,
            parent: None,
            post: None,
            replies: None,
