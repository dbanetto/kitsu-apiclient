...
pub struct InlineResponse20058DataAttributesStatsData {
    /// Omitted if not **activity-history** kind
    #[serde(rename = "activity", skip_serializing_if = "Option::is_none")]
    pub activity: Option<Vec<crate::models::AnyType>>,
    #[serde(rename = "all_categories", skip_serializing_if = "Option::is_none")]
    pub all_categories: Option<crate::models::InlineResponse20058DataAttributesStatsDataAllCategories>,
    #[serde(rename = "all_time", skip_serializing_if = "Option::is_none")]
    pub all_time: Option<crate::models::InlineResponse20058DataAttributesStatsDataAllTime>,
    #[serde(rename = "all_years", skip_serializing_if = "Option::is_none")]
    pub all_years: Option<crate::models::InlineResponse20058DataAttributesStatsDataAllYears>,
    /// Total media in collection. Omitted for **amount-consumed** kinds
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<f32>,
    /// Omitted if not **category-breakdown** or **favorite-year** kind
    #[serde(rename = "total_media", skip_serializing_if = "Option::is_none")]
    pub total_media: Option<f32>,
}

impl InlineResponse20058DataAttributesStatsData {
    pub fn new() -> InlineResponse20058DataAttributesStatsData {
        InlineResponse20058DataAttributesStatsData {
            activity: None,
            all_categories: None,
            all_time: None,
            all_years: None,
