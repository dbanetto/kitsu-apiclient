...
pub struct InlineResponse20060DataAttributes {
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "dubs", skip_serializing_if = "Option::is_none")]
    pub dubs: Option<Vec<crate::models::AnyType>>,
    #[serde(rename = "subs", skip_serializing_if = "Option::is_none")]
    pub subs: Option<Vec<crate::models::AnyType>>,
...
impl InlineResponse20060DataAttributes {
    pub fn new() -> InlineResponse20060DataAttributes {
        InlineResponse20060DataAttributes {
            created_at: None,
            dubs: None,
            subs: None,
            updated_at: None,
