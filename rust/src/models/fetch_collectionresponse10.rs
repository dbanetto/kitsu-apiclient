...
pub struct FetchCollectionresponse10 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Comments>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse10 {
    pub fn new(data: Vec<crate::models::Comments>, meta: crate::models::Meta14) -> FetchCollectionresponse10 {
