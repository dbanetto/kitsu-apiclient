...
pub struct InlineResponse20011Data {
    ...
    pub relationships: Option<crate::models::InlineResponse20011DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl InlineResponse20011Data {
    pub fn new(id: String, _type: String) -> InlineResponse20011Data {
