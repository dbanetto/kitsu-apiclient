...
pub struct GroupInvitesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::GroupInvites>,
    #[serde(rename = "meta")]
...
impl GroupInvitesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::GroupInvites>, meta: crate::models::Meta14) -> GroupInvitesFetchCollectionresponse {
        GroupInvitesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
