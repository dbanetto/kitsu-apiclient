...
pub struct InlineResponse20049DataAttributes {
    ...
    #[serde(rename = "contentFormatted", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "postLikesCount", skip_serializing_if = "Option::is_none")]
    pub post_likes_count: Option<f32>,
    #[serde(rename = "spoiler", skip_serializing_if = "Option::is_none")]
    pub spoiler: Option<bool>,
    #[serde(rename = "targetInterest", skip_serializing_if = "Option::is_none")]
    pub target_interest: Option<String>,
    #[serde(rename = "topLevelCommentsCount", skip_serializing_if = "Option::is_none")]
    pub top_level_comments_count: Option<f32>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl InlineResponse20049DataAttributes {
    pub fn new() -> InlineResponse20049DataAttributes {
        InlineResponse20049DataAttributes {
            blocked: None,
            comments_count: None,
            content: None,
            content_formatted: None,
            created_at: None,
            deleted_at: None,
            edited_at: None,
            embed: None,
