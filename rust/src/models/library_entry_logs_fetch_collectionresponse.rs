...
pub struct LibraryEntryLogsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::LibraryEntryLogs>,
    #[serde(rename = "meta")]
...
impl LibraryEntryLogsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::LibraryEntryLogs>, meta: crate::models::Meta14) -> LibraryEntryLogsFetchCollectionresponse {
        LibraryEntryLogsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
