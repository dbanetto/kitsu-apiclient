...
pub struct InlineResponse20015Data {
    ...
    pub relationships: Option<crate::models::InlineResponse20015DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl InlineResponse20015Data {
    pub fn new(id: String, _type: String) -> InlineResponse20015Data {
