...
pub struct InlineResponse20041DataAttributes {
...
impl InlineResponse20041DataAttributes {
    pub fn new() -> InlineResponse20041DataAttributes {
        InlineResponse20041DataAttributes {
            created_at: None,
            updated_at: None,
            vote: None,
        }
