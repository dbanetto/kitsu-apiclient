...
pub struct InlineResponse20023Data {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::InlineResponse2005DataAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl InlineResponse20023Data {
    pub fn new(id: String, _type: String) -> InlineResponse20023Data {
