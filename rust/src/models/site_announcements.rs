...
pub struct SiteAnnouncements {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::SiteAnnouncementsAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl SiteAnnouncements {
    pub fn new(id: String, _type: String) -> SiteAnnouncements {
        SiteAnnouncements {
            attributes: None,
            id,
            links: None,
