...
pub struct InlineResponse20028DataRelationships {
    #[serde(rename = "actionLogs", skip_serializing_if = "Option::is_none")]
    pub action_logs: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "category", skip_serializing_if = "Option::is_none")]
    pub category: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "invites", skip_serializing_if = "Option::is_none")]
    pub invites: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "leaderChatMessages", skip_serializing_if = "Option::is_none")]
    pub leader_chat_messages: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "members", skip_serializing_if = "Option::is_none")]
    pub members: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "neighbors", skip_serializing_if = "Option::is_none")]
    pub neighbors: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    ...
    pub reports: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "tickets", skip_serializing_if = "Option::is_none")]
    pub tickets: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse20028DataRelationships {
    pub fn new() -> InlineResponse20028DataRelationships {
        InlineResponse20028DataRelationships {
            action_logs: None,
            category: None,
            invites: None,
            leader_chat_messages: None,
            members: None,
            neighbors: None,
            pinned_post: None,
            reports: None,
