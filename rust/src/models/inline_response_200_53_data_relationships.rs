...
pub struct InlineResponse20053DataRelationships {
...
impl InlineResponse20053DataRelationships {
    pub fn new() -> InlineResponse20053DataRelationships {
        InlineResponse20053DataRelationships {
            moderator: None,
            naughty: None,
            user: None,
        }
