...
pub struct InlineResponse20063DataRelationships {
    #[serde(rename = "blocks", skip_serializing_if = "Option::is_none")]
    pub blocks: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "favorites", skip_serializing_if = "Option::is_none")]
    pub favorites: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "followers", skip_serializing_if = "Option::is_none")]
    pub followers: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "following", skip_serializing_if = "Option::is_none")]
    pub following: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "libraryEntries", skip_serializing_if = "Option::is_none")]
    pub library_entries: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "linkedAccounts", skip_serializing_if = "Option::is_none")]
    pub linked_accounts: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "notificationSettings", skip_serializing_if = "Option::is_none")]
    pub notification_settings: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "oneSignalPlayers", skip_serializing_if = "Option::is_none")]
    pub one_signal_players: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "pinnedPost", skip_serializing_if = "Option::is_none")]
    pub pinned_post: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "profileLinks", skip_serializing_if = "Option::is_none")]
    pub profile_links: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    ...
    pub stats: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "userRoles", skip_serializing_if = "Option::is_none")]
    pub user_roles: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "waifu", skip_serializing_if = "Option::is_none")]
    pub waifu: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse20063DataRelationships {
    pub fn new() -> InlineResponse20063DataRelationships {
        InlineResponse20063DataRelationships {
            blocks: None,
            favorites: None,
            followers: None,
            following: None,
