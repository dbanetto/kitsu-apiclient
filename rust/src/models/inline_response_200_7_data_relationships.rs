...
pub struct InlineResponse2007DataRelationships {
...
impl InlineResponse2007DataRelationships {
    pub fn new() -> InlineResponse2007DataRelationships {
        InlineResponse2007DataRelationships {
            anime: None,
            drama: None,
            manga: None,
            parent: None,
