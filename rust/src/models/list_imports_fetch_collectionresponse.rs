...
pub struct ListImportsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::ListImports>,
    #[serde(rename = "meta")]
...
impl ListImportsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::ListImports>, meta: crate::models::Meta14) -> ListImportsFetchCollectionresponse {
        ListImportsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
