...
pub struct FetchCollectionresponse2 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Categories>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse2 {
    pub fn new(data: Vec<crate::models::Categories>, meta: crate::models::Meta14) -> FetchCollectionresponse2 {
