...
pub struct MappingsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Mappings>,
    #[serde(rename = "meta")]
...
impl MappingsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Mappings>, meta: crate::models::Meta14) -> MappingsFetchCollectionresponse {
        MappingsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
