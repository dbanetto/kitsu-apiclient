...
pub struct Relationships25 {
    ...
    pub drama_characters: Option<crate::models::DramaCharacters>,
    #[serde(rename = "dramaStaff", skip_serializing_if = "Option::is_none")]
    pub drama_staff: Option<crate::models::DramaStaff>,
}

impl Relationships25 {
    pub fn new() -> Relationships25 {
        Relationships25 {
            genres: None,
            categories: None,
            castings: None,
