...
pub struct InlineResponse20035DataAttributesToken {
    #[serde(rename = "application", skip_serializing_if = "Option::is_none")]
    pub application: Option<crate::models::InlineResponse20035DataAttributesTokenApplication>,
    #[serde(rename = "created_at", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<f32>,
    #[serde(rename = "expires_in_seconds", skip_serializing_if = "Option::is_none")]
    pub expires_in_seconds: Option<f32>,
    #[serde(rename = "resource_owner_id", skip_serializing_if = "Option::is_none")]
    pub resource_owner_id: Option<f32>,
    #[serde(rename = "scopes", skip_serializing_if = "Option::is_none")]
    pub scopes: Option<Vec<crate::models::AnyType>>,
}

impl InlineResponse20035DataAttributesToken {
    pub fn new() -> InlineResponse20035DataAttributesToken {
        InlineResponse20035DataAttributesToken {
            application: None,
            created_at: None,
