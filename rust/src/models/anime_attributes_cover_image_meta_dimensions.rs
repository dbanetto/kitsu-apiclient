...
pub struct AnimeAttributesCoverImageMetaDimensions {
...
impl AnimeAttributesCoverImageMetaDimensions {
    pub fn new() -> AnimeAttributesCoverImageMetaDimensions {
        AnimeAttributesCoverImageMetaDimensions {
            large: None,
            small: None,
            tiny: None,
        }
