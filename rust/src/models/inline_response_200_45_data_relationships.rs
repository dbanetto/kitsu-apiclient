...
pub struct InlineResponse20045DataRelationships {
    ...
    #[serde(rename = "libraryEntry", skip_serializing_if = "Option::is_none")]
    pub library_entry: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    ...
    pub votes: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse20045DataRelationships {
    pub fn new() -> InlineResponse20045DataRelationships {
        InlineResponse20045DataRelationships {
            anime: None,
            drama: None,
            library_entry: None,
            manga: None,
