...
pub struct FetchCollectionresponse7 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::LibraryEntries>,
    #[serde(rename = "meta")]
    pub meta: crate::models::Meta39,
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<crate::models::Links265>,
}

impl FetchCollectionresponse7 {
    pub fn new(data: Vec<crate::models::LibraryEntries>, meta: crate::models::Meta39) -> FetchCollectionresponse7 {
