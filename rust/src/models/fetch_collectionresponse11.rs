...
pub struct FetchCollectionresponse11 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::AnimeCharacters>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse11 {
    pub fn new(data: Vec<crate::models::AnimeCharacters>, meta: crate::models::Meta14) -> FetchCollectionresponse11 {
