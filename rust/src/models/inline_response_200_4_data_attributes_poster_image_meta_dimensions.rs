...
pub struct InlineResponse2004DataAttributesPosterImageMetaDimensions {
    #[serde(rename = "large", skip_serializing_if = "Option::is_none")]
    pub large: Option<crate::models::InlineResponse2004DataAttributesCoverImageMetaDimensionsLarge>,
    #[serde(rename = "medium", skip_serializing_if = "Option::is_none")]
    pub medium: Option<crate::models::InlineResponse2004DataAttributesCoverImageMetaDimensionsLarge>,
    #[serde(rename = "small", skip_serializing_if = "Option::is_none")]
    pub small: Option<crate::models::InlineResponse2004DataAttributesCoverImageMetaDimensionsLarge>,
    #[serde(rename = "tiny", skip_serializing_if = "Option::is_none")]
    pub tiny: Option<crate::models::InlineResponse2004DataAttributesCoverImageMetaDimensionsLarge>,
}

impl InlineResponse2004DataAttributesPosterImageMetaDimensions {
    pub fn new() -> InlineResponse2004DataAttributesPosterImageMetaDimensions {
        InlineResponse2004DataAttributesPosterImageMetaDimensions {
            large: None,
            medium: None,
            small: None,
            tiny: None,
