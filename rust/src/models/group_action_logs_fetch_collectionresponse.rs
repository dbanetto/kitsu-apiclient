...
pub struct GroupActionLogsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::GroupActionLogs>,
    #[serde(rename = "meta")]
...
impl GroupActionLogsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::GroupActionLogs>, meta: crate::models::Meta14) -> GroupActionLogsFetchCollectionresponse {
        GroupActionLogsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
