...
pub struct InlineResponse20039DataRelationships {
    ...
    pub chapters: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    ...
    #[serde(rename = "mangaCharacters", skip_serializing_if = "Option::is_none")]
    pub manga_characters: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "mangaStaff", skip_serializing_if = "Option::is_none")]
    pub manga_staff: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
...
impl InlineResponse20039DataRelationships {
    pub fn new() -> InlineResponse20039DataRelationships {
        InlineResponse20039DataRelationships {
            castings: None,
            categories: None,
            chapters: None,
            genres: None,
            installments: None,
            manga_characters: None,
            manga_staff: None,
            mappings: None,
