...
pub struct GroupReportsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::GroupReports>,
    #[serde(rename = "meta")]
...
impl GroupReportsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::GroupReports>, meta: crate::models::Meta14) -> GroupReportsFetchCollectionresponse {
        GroupReportsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
