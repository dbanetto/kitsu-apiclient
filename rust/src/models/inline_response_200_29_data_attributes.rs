...
pub struct InlineResponse20029DataAttributes {
...
impl InlineResponse20029DataAttributes {
    pub fn new() -> InlineResponse20029DataAttributes {
        InlineResponse20029DataAttributes {
            created_at: None,
            position: None,
            tag: None,
            updated_at: None,
