...
pub struct RolesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Roles>,
    #[serde(rename = "meta")]
...
impl RolesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Roles>, meta: crate::models::Meta14) -> RolesFetchCollectionresponse {
        RolesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
