...
pub struct MangaCharactersFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::MangaCharacters>,
    #[serde(rename = "meta")]
...
impl MangaCharactersFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::MangaCharacters>, meta: crate::models::Meta14) -> MangaCharactersFetchCollectionresponse {
        MangaCharactersFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
