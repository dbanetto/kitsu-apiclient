...
pub struct MangaStaffFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::MangaStaff>,
    #[serde(rename = "meta")]
...
impl MangaStaffFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::MangaStaff>, meta: crate::models::Meta14) -> MangaStaffFetchCollectionresponse {
        MangaStaffFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
