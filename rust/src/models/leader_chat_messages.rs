...
pub struct LeaderChatMessages {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::LeaderChatMessagesAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl LeaderChatMessages {
    pub fn new(id: String, _type: String) -> LeaderChatMessages {
        LeaderChatMessages {
            attributes: None,
            id,
            links: None,
