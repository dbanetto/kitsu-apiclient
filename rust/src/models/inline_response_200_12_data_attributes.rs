...
pub struct InlineResponse20012DataAttributes {
    ...
    pub likes_count: Option<f32>,
    #[serde(rename = "repliesCount", skip_serializing_if = "Option::is_none")]
    pub replies_count: Option<f32>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl InlineResponse20012DataAttributes {
    pub fn new() -> InlineResponse20012DataAttributes {
        InlineResponse20012DataAttributes {
            blocked: None,
            content: None,
