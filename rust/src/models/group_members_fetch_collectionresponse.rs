...
pub struct GroupMembersFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::GroupMembers>,
    #[serde(rename = "meta")]
...
impl GroupMembersFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::GroupMembers>, meta: crate::models::Meta14) -> GroupMembersFetchCollectionresponse {
        GroupMembersFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
