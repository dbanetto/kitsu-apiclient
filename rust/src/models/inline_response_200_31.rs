...
pub struct InlineResponse20031 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::AnyType>,
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<crate::models::InlineResponse200Links>,
    #[serde(rename = "meta")]
    pub meta: crate::models::InlineResponse20031Meta,
}

impl InlineResponse20031 {
    pub fn new(data: Vec<crate::models::AnyType>, meta: crate::models::InlineResponse20031Meta) -> InlineResponse20031 {
        InlineResponse20031 {
            data,
            links: None,
            meta,
