...
pub struct FetchCollectionresponse8 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::MediaReactionVotes>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse8 {
    pub fn new(data: Vec<crate::models::MediaReactionVotes>, meta: crate::models::Meta14) -> FetchCollectionresponse8 {
