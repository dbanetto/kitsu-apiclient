...
pub struct ReviewLikesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::ReviewLikes>,
    #[serde(rename = "meta")]
...
impl ReviewLikesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::ReviewLikes>, meta: crate::models::Meta14) -> ReviewLikesFetchCollectionresponse {
        ReviewLikesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
