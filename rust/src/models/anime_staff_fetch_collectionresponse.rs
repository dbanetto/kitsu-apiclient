...
pub struct AnimeStaffFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::AnimeStaff>,
    #[serde(rename = "meta")]
...
impl AnimeStaffFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::AnimeStaff>, meta: crate::models::Meta14) -> AnimeStaffFetchCollectionresponse {
        AnimeStaffFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
