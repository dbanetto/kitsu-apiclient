...
pub struct InlineResponse20017DataRelationships {
    #[serde(rename = "group", skip_serializing_if = "Option::is_none")]
    pub group: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "target", skip_serializing_if = "Option::is_none")]
    pub target: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse20017DataRelationships {
    pub fn new() -> InlineResponse20017DataRelationships {
        InlineResponse20017DataRelationships {
            group: None,
            target: None,
            user: None,
        }
