...
pub struct InlineResponse20054Data {
    ...
    pub relationships: Option<crate::models::InlineResponse20054DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl InlineResponse20054Data {
    pub fn new(id: String, _type: String) -> InlineResponse20054Data {
