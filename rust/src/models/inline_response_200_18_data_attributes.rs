...
pub struct InlineResponse20018DataAttributes {
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "notes", skip_serializing_if = "Option::is_none")]
    pub notes: Option<String>,
    #[serde(rename = "notesFormatted", skip_serializing_if = "Option::is_none")]
    pub notes_formatted: Option<String>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl InlineResponse20018DataAttributes {
    pub fn new() -> InlineResponse20018DataAttributes {
        InlineResponse20018DataAttributes {
            created_at: None,
            notes: None,
            notes_formatted: None,
            updated_at: None,
        }
    }
}
