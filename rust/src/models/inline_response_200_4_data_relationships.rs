...
pub struct InlineResponse2004DataRelationships {
    #[serde(rename = "animeCharacters", skip_serializing_if = "Option::is_none")]
    pub anime_characters: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "animeProductions", skip_serializing_if = "Option::is_none")]
    pub anime_productions: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "animeStaff", skip_serializing_if = "Option::is_none")]
    pub anime_staff: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "castings", skip_serializing_if = "Option::is_none")]
    pub castings: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "categories", skip_serializing_if = "Option::is_none")]
    pub categories: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "episodes", skip_serializing_if = "Option::is_none")]
    pub episodes: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "genres", skip_serializing_if = "Option::is_none")]
    pub genres: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "installments", skip_serializing_if = "Option::is_none")]
    pub installments: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "mappings", skip_serializing_if = "Option::is_none")]
    pub mappings: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "mediaRelationships", skip_serializing_if = "Option::is_none")]
    pub media_relationships: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "reviews", skip_serializing_if = "Option::is_none")]
    pub reviews: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "streamingLinks", skip_serializing_if = "Option::is_none")]
    pub streaming_links: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse2004DataRelationships {
    pub fn new() -> InlineResponse2004DataRelationships {
        InlineResponse2004DataRelationships {
            anime_characters: None,
            anime_productions: None,
            anime_staff: None,
            castings: None,
            categories: None,
            episodes: None,
