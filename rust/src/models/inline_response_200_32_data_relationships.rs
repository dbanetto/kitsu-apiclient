...
pub struct InlineResponse20032DataRelationships {
    #[serde(rename = "anime", skip_serializing_if = "Option::is_none")]
    pub anime: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "drama", skip_serializing_if = "Option::is_none")]
    pub drama: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "manga", skip_serializing_if = "Option::is_none")]
    pub manga: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "media", skip_serializing_if = "Option::is_none")]
    pub media: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "mediaReaction", skip_serializing_if = "Option::is_none")]
    pub media_reaction: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "nextUnit", skip_serializing_if = "Option::is_none")]
    pub next_unit: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "review", skip_serializing_if = "Option::is_none")]
    pub review: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "unit", skip_serializing_if = "Option::is_none")]
    pub unit: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse20032DataRelationships {
    pub fn new() -> InlineResponse20032DataRelationships {
        InlineResponse20032DataRelationships {
            anime: None,
            drama: None,
            manga: None,
            media: None,
