...
pub struct MangaAttributes {
    ...
    pub titles: Option<crate::models::Titles>,
    ...
    pub rating_frequencies: Option<::std::collections::HashMap<String, String>>,
    ...
    pub poster_image: Option<crate::models::PosterImage>,
    #[serde(rename = "coverImage", skip_serializing_if = "Option::is_none")]
    pub cover_image: Option<crate::models::CoverImage>,
    ...
    pub manga_type: Option<crate::models::MangaType>,
}

impl MangaAttributes {
    pub fn new() -> MangaAttributes {
        MangaAttributes {
            created_at: None,
            updated_at: None,
            slug: None,
