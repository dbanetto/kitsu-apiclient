...
pub struct GroupPermissionsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::GroupPermissions>,
    #[serde(rename = "meta")]
...
impl GroupPermissionsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::GroupPermissions>, meta: crate::models::Meta14) -> GroupPermissionsFetchCollectionresponse {
        GroupPermissionsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
