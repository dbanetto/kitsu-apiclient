...
pub struct InlineResponse20040DataAttributes {
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "externalId", skip_serializing_if = "Option::is_none")]
    pub external_id: Option<String>,
    /// Non-exaustive list, new sites may be added over time
    #[serde(rename = "externalSite", skip_serializing_if = "Option::is_none")]
    pub external_site: Option<ExternalSite>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl InlineResponse20040DataAttributes {
    pub fn new() -> InlineResponse20040DataAttributes {
        InlineResponse20040DataAttributes {
            created_at: None,
            external_id: None,
            external_site: None,
            updated_at: None,
