...
pub struct ProfileLinksFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::ProfileLinks>,
    #[serde(rename = "meta")]
...
impl ProfileLinksFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::ProfileLinks>, meta: crate::models::Meta14) -> ProfileLinksFetchCollectionresponse {
        ProfileLinksFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
