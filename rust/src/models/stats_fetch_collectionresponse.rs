...
pub struct StatsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Stats>,
    #[serde(rename = "meta")]
...
impl StatsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Stats>, meta: crate::models::Meta14) -> StatsFetchCollectionresponse {
        StatsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
