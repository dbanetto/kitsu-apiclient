...
pub struct CategoryFavorites {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::CategoryFavoritesAttributes>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<crate::models::InlineResponse2001DataLinks>,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<crate::models::InlineResponse2008DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl CategoryFavorites {
    pub fn new(id: String, _type: String) -> CategoryFavorites {
        CategoryFavorites {
            attributes: None,
            id,
            links: None,
