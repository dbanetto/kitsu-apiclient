...
impl Relationships19 {
    pub fn new() -> Relationships19 {
        Relationships19 {
            members: None,
            neighbors: None,
            tickets: None,
