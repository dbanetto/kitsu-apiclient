...
pub struct ProfileLinkSites {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::ProfileLinkSitesAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl ProfileLinkSites {
    pub fn new(id: String, _type: String) -> ProfileLinkSites {
        ProfileLinkSites {
            attributes: None,
            id,
            links: None,
