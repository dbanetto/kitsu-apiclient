...
pub struct InlineResponse20041DataRelationships {
    #[serde(rename = "animeMediaAttribute", skip_serializing_if = "Option::is_none")]
    pub anime_media_attribute: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "dramasMediaAttribute", skip_serializing_if = "Option::is_none")]
    pub dramas_media_attribute: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "mangaMediaAttribute", skip_serializing_if = "Option::is_none")]
    pub manga_media_attribute: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse20041DataRelationships {
    pub fn new() -> InlineResponse20041DataRelationships {
        InlineResponse20041DataRelationships {
            anime_media_attribute: None,
            dramas_media_attribute: None,
            manga_media_attribute: None,
            user: None,
        }
    }
}
