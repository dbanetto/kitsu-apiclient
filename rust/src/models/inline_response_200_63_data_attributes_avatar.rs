...
pub struct InlineResponse20063DataAttributesAvatar {
    ...
    pub meta: Option<crate::models::InlineResponse20063DataAttributesAvatarMeta>,
...
impl InlineResponse20063DataAttributesAvatar {
    pub fn new() -> InlineResponse20063DataAttributesAvatar {
        InlineResponse20063DataAttributesAvatar {
            large: None,
            medium: None,
            meta: None,
            original: None,
