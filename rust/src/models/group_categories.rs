...
pub struct GroupCategories {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::GroupCategoriesAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl GroupCategories {
    pub fn new(id: String, _type: String) -> GroupCategories {
        GroupCategories {
            attributes: None,
            id,
            links: None,
