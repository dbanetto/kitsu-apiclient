...
pub struct MediaReactionsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::MediaReactions>,
    #[serde(rename = "meta")]
...
impl MediaReactionsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::MediaReactions>, meta: crate::models::Meta14) -> MediaReactionsFetchCollectionresponse {
        MediaReactionsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
