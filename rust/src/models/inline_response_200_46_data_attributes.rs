...
pub struct InlineResponse20046DataAttributes {
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    /// Relation to the source media
...
impl InlineResponse20046DataAttributes {
    pub fn new() -> InlineResponse20046DataAttributes {
        InlineResponse20046DataAttributes {
            created_at: None,
            role: None,
            updated_at: None,
        }
