...
pub struct Relationships44 {
    ...
    pub library_entry: Option<crate::models::LibraryEntry>,
    #[serde(rename = "votes", skip_serializing_if = "Option::is_none")]
    pub votes: Option<crate::models::Votes>,
}

impl Relationships44 {
    pub fn new() -> Relationships44 {
        Relationships44 {
            anime: None,
            drama: None,
            manga: None,
