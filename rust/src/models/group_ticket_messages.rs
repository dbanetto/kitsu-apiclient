...
pub struct GroupTicketMessages {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::GroupTicketMessagesAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl GroupTicketMessages {
    pub fn new(id: String, _type: String) -> GroupTicketMessages {
        GroupTicketMessages {
            attributes: None,
            id,
            links: None,
