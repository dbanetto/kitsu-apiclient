...
/// InlineResponse2004DataAttributesTitles : Titles in different languages. Other languages will be listed if they exist.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse2004DataAttributesTitles {
    #[serde(rename = "en", skip_serializing_if = "Option::is_none")]
    pub en: Option<String>,
    #[serde(rename = "en_jp", skip_serializing_if = "Option::is_none")]
    pub en_jp: Option<String>,
    #[serde(rename = "ja_jp", skip_serializing_if = "Option::is_none")]
    pub ja_jp: Option<String>,
}

impl InlineResponse2004DataAttributesTitles {
    /// Titles in different languages. Other languages will be listed if they exist.
    pub fn new() -> InlineResponse2004DataAttributesTitles {
        InlineResponse2004DataAttributesTitles {
            en: None,
            en_jp: None,
            ja_jp: None,
        }
