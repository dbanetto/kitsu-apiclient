...
pub struct InlineResponse20014DataAttributes {
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "favRank", skip_serializing_if = "Option::is_none")]
    pub fav_rank: Option<f32>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl InlineResponse20014DataAttributes {
    pub fn new() -> InlineResponse20014DataAttributes {
        InlineResponse20014DataAttributes {
            created_at: None,
            fav_rank: None,
            updated_at: None,
        }
