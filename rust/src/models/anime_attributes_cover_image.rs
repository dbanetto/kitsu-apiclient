...
pub struct AnimeAttributesCoverImage {
    #[serde(rename = "large", skip_serializing_if = "Option::is_none")]
    pub large: Option<String>,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<crate::models::AnimeAttributesCoverImageMeta>,
...
impl AnimeAttributesCoverImage {
    pub fn new() -> AnimeAttributesCoverImage {
        AnimeAttributesCoverImage {
            large: None,
            meta: None,
            original: None,
            small: None,
