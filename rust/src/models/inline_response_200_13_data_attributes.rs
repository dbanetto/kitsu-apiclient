...
pub struct InlineResponse20013DataAttributes {
    /// YYYY-MM-DD date
    ...
    #[serde(rename = "relativeNumber", skip_serializing_if = "Option::is_none")]
    pub relative_number: Option<f32>,
    ...
    pub thumbnail: Option<crate::models::InlineResponse2009DataAttributesThumbnail>,
    #[serde(rename = "titles", skip_serializing_if = "Option::is_none")]
    pub titles: Option<crate::models::InlineResponse2009DataAttributesTitles>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl InlineResponse20013DataAttributes {
    pub fn new() -> InlineResponse20013DataAttributes {
        InlineResponse20013DataAttributes {
            airdate: None,
