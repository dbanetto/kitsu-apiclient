...
pub struct InlineResponse20017DataAttributes {
...
impl InlineResponse20017DataAttributes {
    pub fn new() -> InlineResponse20017DataAttributes {
        InlineResponse20017DataAttributes {
            created_at: None,
            updated_at: None,
            verb: None,
        }
