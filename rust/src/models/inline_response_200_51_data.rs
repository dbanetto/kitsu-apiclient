...
pub struct InlineResponse20051Data {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::InlineResponse20051DataAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl InlineResponse20051Data {
    pub fn new(id: String, _type: String) -> InlineResponse20051Data {
