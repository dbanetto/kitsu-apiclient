...
pub struct FranchisesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Franchises>,
    #[serde(rename = "meta")]
...
impl FranchisesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Franchises>, meta: crate::models::Meta14) -> FranchisesFetchCollectionresponse {
        FranchisesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
