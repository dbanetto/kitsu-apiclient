...
pub struct FetchCollectionresponse12 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::AnimeProductions>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse12 {
    pub fn new(data: Vec<crate::models::AnimeProductions>, meta: crate::models::Meta14) -> FetchCollectionresponse12 {
