...
pub struct ProducersFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Producers>,
    #[serde(rename = "meta")]
...
impl ProducersFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Producers>, meta: crate::models::Meta14) -> ProducersFetchCollectionresponse {
        ProducersFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
