...
pub struct AnimeAttributesPosterImage {
    ...
    pub meta: Option<crate::models::AnimeAttributesPosterImageMeta>,
...
impl AnimeAttributesPosterImage {
    pub fn new() -> AnimeAttributesPosterImage {
        AnimeAttributesPosterImage {
            large: None,
            medium: None,
            meta: None,
            original: None,
