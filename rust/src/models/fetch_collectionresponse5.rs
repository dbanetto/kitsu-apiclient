...
pub struct FetchCollectionresponse5 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Streamers>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse5 {
    pub fn new(data: Vec<crate::models::Streamers>, meta: crate::models::Meta14) -> FetchCollectionresponse5 {
