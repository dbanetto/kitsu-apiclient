...
pub struct LibraryEntryLogs {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::LibraryEntryLogsAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl LibraryEntryLogs {
    pub fn new(id: String, _type: String) -> LibraryEntryLogs {
        LibraryEntryLogs {
            attributes: None,
            id,
            links: None,
