...
pub struct FetchCollectionresponse15 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::SiteAnnouncements>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse15 {
    pub fn new(data: Vec<crate::models::SiteAnnouncements>, meta: crate::models::Meta14) -> FetchCollectionresponse15 {
