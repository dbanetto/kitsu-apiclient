...
pub struct GroupMemberNotesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::GroupMemberNotes>,
    #[serde(rename = "meta")]
...
impl GroupMemberNotesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::GroupMemberNotes>, meta: crate::models::Meta14) -> GroupMemberNotesFetchCollectionresponse {
        GroupMemberNotesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
