...
/// InlineResponse20058DataAttributesStatsDataAllCategories : Omitted if not **category-breakdown** kind



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct InlineResponse20058DataAttributesStatsDataAllCategories {
    #[serde(rename = "alien", skip_serializing_if = "Option::is_none")]
    pub alien: Option<f32>,
    #[serde(rename = "angel", skip_serializing_if = "Option::is_none")]
    pub angel: Option<f32>,
    #[serde(rename = "angst", skip_serializing_if = "Option::is_none")]
    pub angst: Option<f32>,
    #[serde(rename = "asia", skip_serializing_if = "Option::is_none")]
    pub asia: Option<f32>,
    #[serde(rename = "china", skip_serializing_if = "Option::is_none")]
    pub china: Option<f32>,
    #[serde(rename = "cops", skip_serializing_if = "Option::is_none")]
    pub cops: Option<f32>,
    #[serde(rename = "crime", skip_serializing_if = "Option::is_none")]
    pub crime: Option<f32>,
    #[serde(rename = "deity", skip_serializing_if = "Option::is_none")]
    pub deity: Option<f32>,
    #[serde(rename = "demon", skip_serializing_if = "Option::is_none")]
    pub demon: Option<f32>,
    #[serde(rename = "idol", skip_serializing_if = "Option::is_none")]
    pub idol: Option<f32>,
    #[serde(rename = "mars", skip_serializing_if = "Option::is_none")]
    pub mars: Option<f32>,
    #[serde(rename = "navy", skip_serializing_if = "Option::is_none")]
    pub navy: Option<f32>,
...
impl InlineResponse20058DataAttributesStatsDataAllCategories {
    /// Omitted if not **category-breakdown** kind
    pub fn new() -> InlineResponse20058DataAttributesStatsDataAllCategories {
        InlineResponse20058DataAttributesStatsDataAllCategories {
            alien: None,
            angel: None,
            angst: None,
            asia: None,
