...
pub struct Relationships60 {
    ...
    pub one_signal_players: Option<crate::models::OneSignalPlayers>,
}

impl Relationships60 {
    pub fn new() -> Relationships60 {
        Relationships60 {
            waifu: None,
            pinned_post: None,
            followers: None,
