...
pub struct GroupTicketMessagesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::GroupTicketMessages>,
    #[serde(rename = "meta")]
    pub meta: crate::models::Meta14,
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<crate::models::Links265>,
}

impl GroupTicketMessagesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::GroupTicketMessages>, meta: crate::models::Meta14) -> GroupTicketMessagesFetchCollectionresponse {
        GroupTicketMessagesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
