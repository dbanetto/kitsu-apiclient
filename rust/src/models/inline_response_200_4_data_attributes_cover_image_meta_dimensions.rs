...
pub struct InlineResponse2004DataAttributesCoverImageMetaDimensions {
...
impl InlineResponse2004DataAttributesCoverImageMetaDimensions {
    pub fn new() -> InlineResponse2004DataAttributesCoverImageMetaDimensions {
        InlineResponse2004DataAttributesCoverImageMetaDimensions {
            large: None,
            small: None,
            tiny: None,
        }
