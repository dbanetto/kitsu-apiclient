...
pub struct UserRolesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::UserRoles>,
    #[serde(rename = "meta")]
...
impl UserRolesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::UserRoles>, meta: crate::models::Meta14) -> UserRolesFetchCollectionresponse {
        UserRolesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
