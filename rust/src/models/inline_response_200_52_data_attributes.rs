...
pub struct InlineResponse20052DataAttributes {
...
impl InlineResponse20052DataAttributes {
    pub fn new() -> InlineResponse20052DataAttributes {
        InlineResponse20052DataAttributes {
            created_at: None,
            updated_at: None,
            url: None,
        }
