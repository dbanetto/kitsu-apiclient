...
pub struct InlineResponse20059DataAttributes {
    ...
    #[serde(rename = "streamingLinksCount", skip_serializing_if = "Option::is_none")]
    pub streaming_links_count: Option<f32>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl InlineResponse20059DataAttributes {
    pub fn new() -> InlineResponse20059DataAttributes {
        InlineResponse20059DataAttributes {
            created_at: None,
            logo: None,
            site_name: None,
            streaming_links_count: None,
            updated_at: None,
        }
    }
}
