...
pub struct ChaptersFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Chapters>,
    #[serde(rename = "meta")]
...
impl ChaptersFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Chapters>, meta: crate::models::Meta14) -> ChaptersFetchCollectionresponse {
        ChaptersFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
