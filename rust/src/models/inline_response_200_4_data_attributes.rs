...
pub struct InlineResponse2004DataAttributes {
    ...
    #[serde(rename = "episodeLength", skip_serializing_if = "Option::is_none")]
...
impl InlineResponse2004DataAttributes {
    pub fn new() -> InlineResponse2004DataAttributes {
