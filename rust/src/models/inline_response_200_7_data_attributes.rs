...
pub struct InlineResponse2007DataAttributes {
    ...
    pub image: Option<crate::models::InlineResponse2004DataAttributesPosterImage>,
    ...
    #[serde(rename = "totalMediaCount", skip_serializing_if = "Option::is_none")]
    pub total_media_count: Option<f32>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl InlineResponse2007DataAttributes {
    pub fn new() -> InlineResponse2007DataAttributes {
        InlineResponse2007DataAttributes {
            child_count: None,
            created_at: None,
            description: None,
            image: None,
