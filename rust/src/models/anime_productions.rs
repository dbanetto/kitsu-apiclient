...
pub struct AnimeProductions {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::AnimeProductionsAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl AnimeProductions {
    pub fn new(id: String, _type: String) -> AnimeProductions {
        AnimeProductions {
            attributes: None,
            id,
            links: None,
