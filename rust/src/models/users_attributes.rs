...
pub struct UsersAttributes {
    ...
    pub past_names: Option<Vec<String>>,
    ...
    pub avatar: Option<crate::models::Avatar1>,
    #[serde(rename = "coverImage", skip_serializing_if = "Option::is_none")]
    pub cover_image: Option<crate::models::CoverImage4>,
    /// Logged in user only
    ...
    pub title_language_preference_canonical: Option<crate::models::TitleLanguagePreferencecanonical>,
    ...
    pub rating_system: Option<crate::models::RatingSystem>,
    #[serde(rename = "theme", skip_serializing_if = "Option::is_none")]
    pub theme: Option<crate::models::Theme>,
    /// Logged in user only
