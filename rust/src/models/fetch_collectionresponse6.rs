...
pub struct FetchCollectionresponse6 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Blocks>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse6 {
    pub fn new(data: Vec<crate::models::Blocks>, meta: crate::models::Meta14) -> FetchCollectionresponse6 {
