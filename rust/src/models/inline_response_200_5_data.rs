...
pub struct InlineResponse2005Data {
    ...
    pub relationships: Option<crate::models::InlineResponse2005DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl InlineResponse2005Data {
    pub fn new(id: String, _type: String) -> InlineResponse2005Data {
