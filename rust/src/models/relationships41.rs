...
pub struct Relationships41 {
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<crate::models::User>,
    #[serde(rename = "targetUser", skip_serializing_if = "Option::is_none")]
    pub target_user: Option<crate::models::TargetUser>,
    #[serde(rename = "targetGroup", skip_serializing_if = "Option::is_none")]
    pub target_group: Option<crate::models::TargetGroup>,
    #[serde(rename = "media", skip_serializing_if = "Option::is_none")]
    pub media: Option<crate::models::Media>,
    #[serde(rename = "spoiledUnit", skip_serializing_if = "Option::is_none")]
    pub spoiled_unit: Option<crate::models::SpoiledUnit>,
    #[serde(rename = "ama", skip_serializing_if = "Option::is_none")]
    pub ama: Option<crate::models::Ama>,
    #[serde(rename = "postLikes", skip_serializing_if = "Option::is_none")]
    pub post_likes: Option<crate::models::PostLikes1>,
    #[serde(rename = "comments", skip_serializing_if = "Option::is_none")]
    pub comments: Option<crate::models::Comments1>,
    #[serde(rename = "uploads", skip_serializing_if = "Option::is_none")]
    pub uploads: Option<crate::models::Uploads>,
}

impl Relationships41 {
    pub fn new() -> Relationships41 {
        Relationships41 {
            user: None,
            target_user: None,
            target_group: None,
