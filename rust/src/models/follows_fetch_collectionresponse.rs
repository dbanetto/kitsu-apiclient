...
pub struct FollowsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Follows>,
    #[serde(rename = "meta")]
...
impl FollowsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Follows>, meta: crate::models::Meta14) -> FollowsFetchCollectionresponse {
        FollowsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
