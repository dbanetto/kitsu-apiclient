...
pub struct InlineResponse2003Data {
    ...
    pub relationships: Option<crate::models::InlineResponse2003DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl InlineResponse2003Data {
    pub fn new(id: String, _type: String) -> InlineResponse2003Data {
