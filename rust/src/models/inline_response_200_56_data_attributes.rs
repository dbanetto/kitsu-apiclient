...
pub struct InlineResponse20056DataAttributes {
...
impl InlineResponse20056DataAttributes {
    pub fn new() -> InlineResponse20056DataAttributes {
        InlineResponse20056DataAttributes {
            created_at: None,
            name: None,
            resource_id: None,
            resource_type: None,
