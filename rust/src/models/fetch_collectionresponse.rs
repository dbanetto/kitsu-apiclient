...
pub struct FetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Anime>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Anime>, meta: crate::models::Meta14) -> FetchCollectionresponse {
