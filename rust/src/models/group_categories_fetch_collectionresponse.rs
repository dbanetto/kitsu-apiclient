...
pub struct GroupCategoriesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::GroupCategories>,
    #[serde(rename = "meta")]
...
impl GroupCategoriesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::GroupCategories>, meta: crate::models::Meta14) -> GroupCategoriesFetchCollectionresponse {
        GroupCategoriesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
