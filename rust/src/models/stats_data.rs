...
pub struct StatsData {
    ...
    pub activity: Option<Vec<crate::models::Activity>>,
    #[serde(rename = "all_categories", skip_serializing_if = "Option::is_none")]
    pub all_categories: Option<crate::models::AllCategories>,
    #[serde(rename = "all_time", skip_serializing_if = "Option::is_none")]
    pub all_time: Option<crate::models::AllTime>,
    #[serde(rename = "all_years", skip_serializing_if = "Option::is_none")]
    pub all_years: Option<::std::collections::HashMap<String, f32>>,
}
