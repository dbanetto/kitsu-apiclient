...
pub struct MediaAttributeVotesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::MediaAttributeVotes>,
    #[serde(rename = "meta")]
...
impl MediaAttributeVotesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::MediaAttributeVotes>, meta: crate::models::Meta14) -> MediaAttributeVotesFetchCollectionresponse {
        MediaAttributeVotesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
