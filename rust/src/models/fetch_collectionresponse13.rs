...
pub struct FetchCollectionresponse13 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Groups>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse13 {
    pub fn new(data: Vec<crate::models::Groups>, meta: crate::models::Meta14) -> FetchCollectionresponse13 {
