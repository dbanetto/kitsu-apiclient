...
pub struct InlineResponse20027DataRelationships {
    #[serde(rename = "assignee", skip_serializing_if = "Option::is_none")]
    pub assignee: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "firstMessage", skip_serializing_if = "Option::is_none")]
    pub first_message: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "group", skip_serializing_if = "Option::is_none")]
    pub group: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "messages", skip_serializing_if = "Option::is_none")]
    pub messages: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse20027DataRelationships {
    pub fn new() -> InlineResponse20027DataRelationships {
        InlineResponse20027DataRelationships {
            assignee: None,
            first_message: None,
            group: None,
            messages: None,
