...
pub struct AnimeAttributesPosterImageMetaDimensions {
    #[serde(rename = "large", skip_serializing_if = "Option::is_none")]
    pub large: Option<crate::models::AnimeAttributesCoverImageMetaDimensionsLarge>,
    #[serde(rename = "medium", skip_serializing_if = "Option::is_none")]
    pub medium: Option<crate::models::AnimeAttributesCoverImageMetaDimensionsLarge>,
    #[serde(rename = "small", skip_serializing_if = "Option::is_none")]
    pub small: Option<crate::models::AnimeAttributesCoverImageMetaDimensionsLarge>,
    #[serde(rename = "tiny", skip_serializing_if = "Option::is_none")]
    pub tiny: Option<crate::models::AnimeAttributesCoverImageMetaDimensionsLarge>,
}

impl AnimeAttributesPosterImageMetaDimensions {
    pub fn new() -> AnimeAttributesPosterImageMetaDimensions {
        AnimeAttributesPosterImageMetaDimensions {
            large: None,
            medium: None,
            small: None,
            tiny: None,
