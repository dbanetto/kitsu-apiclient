...
pub struct InlineResponse2007Data {
    ...
    pub attributes: Option<crate::models::InlineResponse2007DataAttributes>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<crate::models::InlineResponse2001DataLinks>,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<crate::models::InlineResponse2007DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl InlineResponse2007Data {
    pub fn new(id: String, _type: String) -> InlineResponse2007Data {
