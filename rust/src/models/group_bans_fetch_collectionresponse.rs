...
pub struct GroupBansFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::GroupBans>,
    #[serde(rename = "meta")]
...
impl GroupBansFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::GroupBans>, meta: crate::models::Meta14) -> GroupBansFetchCollectionresponse {
        GroupBansFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
