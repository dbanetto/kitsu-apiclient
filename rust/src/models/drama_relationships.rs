...
pub struct DramaRelationships {
    ...
    #[serde(rename = "dramaCharacters", skip_serializing_if = "Option::is_none")]
    pub drama_characters: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "dramaStaff", skip_serializing_if = "Option::is_none")]
    pub drama_staff: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
...
impl DramaRelationships {
    pub fn new() -> DramaRelationships {
        DramaRelationships {
            castings: None,
            categories: None,
            drama_characters: None,
            drama_staff: None,
            episodes: None,
            genres: None,
            installments: None,
