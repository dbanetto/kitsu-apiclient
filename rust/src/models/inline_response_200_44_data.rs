...
pub struct InlineResponse20044Data {
    ...
    pub relationships: Option<crate::models::InlineResponse20044DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl InlineResponse20044Data {
    pub fn new(id: String, _type: String) -> InlineResponse20044Data {
