...
pub struct MediaAttributesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::MediaAttributes>,
    #[serde(rename = "meta")]
...
impl MediaAttributesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::MediaAttributes>, meta: crate::models::Meta14) -> MediaAttributesFetchCollectionresponse {
        MediaAttributesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
