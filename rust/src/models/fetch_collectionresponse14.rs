...
pub struct FetchCollectionresponse14 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Reports>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse14 {
    pub fn new(data: Vec<crate::models::Reports>, meta: crate::models::Meta14) -> FetchCollectionresponse14 {
