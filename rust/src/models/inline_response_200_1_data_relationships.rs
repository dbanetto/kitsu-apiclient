...
pub struct InlineResponse2001DataRelationships {
    ...
    /// +links (object)     + self: `https://kitsu.io/api/edge/anime-characters/1/relationships/character`     + related: `https://kitsu.io/api/edge/anime-characters/1/character`
    #[serde(rename = "character", skip_serializing_if = "Option::is_none")]
    pub character: Option<serde_json::Value>,
}

impl InlineResponse2001DataRelationships {
    pub fn new() -> InlineResponse2001DataRelationships {
