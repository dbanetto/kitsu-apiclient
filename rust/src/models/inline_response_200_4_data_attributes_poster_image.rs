...
pub struct InlineResponse2004DataAttributesPosterImage {
    ...
    pub meta: Option<crate::models::InlineResponse2004DataAttributesPosterImageMeta>,
...
impl InlineResponse2004DataAttributesPosterImage {
    pub fn new() -> InlineResponse2004DataAttributesPosterImage {
        InlineResponse2004DataAttributesPosterImage {
            large: None,
            medium: None,
            meta: None,
            original: None,
