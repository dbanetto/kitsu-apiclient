...
pub struct GroupTicketsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::GroupTickets>,
    #[serde(rename = "meta")]
...
impl GroupTicketsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::GroupTickets>, meta: crate::models::Meta14) -> GroupTicketsFetchCollectionresponse {
        GroupTicketsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
