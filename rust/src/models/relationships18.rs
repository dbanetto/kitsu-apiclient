...
pub struct Relationships18 {
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<crate::models::User>,
    #[serde(rename = "group", skip_serializing_if = "Option::is_none")]
    pub group: Option<crate::models::Group>,
    #[serde(rename = "assignee", skip_serializing_if = "Option::is_none")]
    pub assignee: Option<crate::models::Assignee>,
    #[serde(rename = "messages", skip_serializing_if = "Option::is_none")]
    pub messages: Option<crate::models::Messages>,
    #[serde(rename = "firstMessage", skip_serializing_if = "Option::is_none")]
    pub first_message: Option<crate::models::FirstMessage>,
}

impl Relationships18 {
    pub fn new() -> Relationships18 {
        Relationships18 {
            user: None,
            group: None,
            assignee: None,
