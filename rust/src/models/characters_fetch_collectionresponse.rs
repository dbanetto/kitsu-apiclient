...
pub struct CharactersFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Characters>,
    #[serde(rename = "meta")]
...
impl CharactersFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Characters>, meta: crate::models::Meta14) -> CharactersFetchCollectionresponse {
        CharactersFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
