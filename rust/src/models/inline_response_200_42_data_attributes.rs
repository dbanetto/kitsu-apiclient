...
pub struct InlineResponse20042DataAttributes {
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "highTitle", skip_serializing_if = "Option::is_none")]
    pub high_title: Option<String>,
    #[serde(rename = "lowTitle", skip_serializing_if = "Option::is_none")]
    pub low_title: Option<String>,
    #[serde(rename = "neutralTitle", skip_serializing_if = "Option::is_none")]
...
impl InlineResponse20042DataAttributes {
    pub fn new() -> InlineResponse20042DataAttributes {
        InlineResponse20042DataAttributes {
            created_at: None,
            high_title: None,
            low_title: None,
            neutral_title: None,
