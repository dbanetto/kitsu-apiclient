...
pub struct InlineResponse20050DataAttributes {
...
impl InlineResponse20050DataAttributes {
    pub fn new() -> InlineResponse20050DataAttributes {
        InlineResponse20050DataAttributes {
            created_at: None,
            name: None,
            slug: None,
            updated_at: None,
