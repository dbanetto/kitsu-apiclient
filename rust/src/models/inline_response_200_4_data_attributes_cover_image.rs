...
pub struct InlineResponse2004DataAttributesCoverImage {
    #[serde(rename = "large", skip_serializing_if = "Option::is_none")]
    pub large: Option<String>,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<crate::models::InlineResponse2004DataAttributesCoverImageMeta>,
...
impl InlineResponse2004DataAttributesCoverImage {
    pub fn new() -> InlineResponse2004DataAttributesCoverImage {
        InlineResponse2004DataAttributesCoverImage {
            large: None,
            meta: None,
            original: None,
            small: None,
