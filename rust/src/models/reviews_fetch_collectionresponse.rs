...
pub struct ReviewsFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Reviews>,
    #[serde(rename = "meta")]
...
impl ReviewsFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Reviews>, meta: crate::models::Meta14) -> ReviewsFetchCollectionresponse {
        ReviewsFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
