...
pub struct InlineResponse20034DataAttributes {
    #[serde(rename = "changedData", skip_serializing_if = "Option::is_none")]
...
impl InlineResponse20034DataAttributes {
    pub fn new() -> InlineResponse20034DataAttributes {
        InlineResponse20034DataAttributes {
            changed_data: None,
            created_at: None,
            event: None,
            notes: None,
