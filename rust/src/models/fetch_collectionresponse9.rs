...
pub struct FetchCollectionresponse9 {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Posts>,
    #[serde(rename = "meta")]
...
impl FetchCollectionresponse9 {
    pub fn new(data: Vec<crate::models::Posts>, meta: crate::models::Meta14) -> FetchCollectionresponse9 {
