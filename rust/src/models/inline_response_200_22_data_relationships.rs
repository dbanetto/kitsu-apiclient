...
pub struct InlineResponse20022DataRelationships {
    #[serde(rename = "group", skip_serializing_if = "Option::is_none")]
    pub group: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "notes", skip_serializing_if = "Option::is_none")]
    pub notes: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "permissions", skip_serializing_if = "Option::is_none")]
    pub permissions: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse20022DataRelationships {
    pub fn new() -> InlineResponse20022DataRelationships {
        InlineResponse20022DataRelationships {
            group: None,
            notes: None,
            permissions: None,
            user: None,
