...
pub struct MediaAttributeVotes {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::MediaAttributeVotesAttributes>,
    #[serde(rename = "id")]
    pub id: String,
...
impl MediaAttributeVotes {
    pub fn new(id: String, _type: String) -> MediaAttributeVotes {
        MediaAttributeVotes {
            attributes: None,
            id,
            links: None,
