...
pub struct InlineResponse2005DataAttributes {
...
impl InlineResponse2005DataAttributes {
    pub fn new() -> InlineResponse2005DataAttributes {
        InlineResponse2005DataAttributes {
            created_at: None,
            updated_at: None,
        }
    }
