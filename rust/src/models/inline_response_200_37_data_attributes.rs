...
pub struct InlineResponse20037DataAttributes {
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    /// Role the character plays in the manga
...
impl InlineResponse20037DataAttributes {
    pub fn new() -> InlineResponse20037DataAttributes {
        InlineResponse20037DataAttributes {
            created_at: None,
            role: None,
            updated_at: None,
        }
