...
pub struct InlineResponse20018DataRelationships {
...
impl InlineResponse20018DataRelationships {
    pub fn new() -> InlineResponse20018DataRelationships {
        InlineResponse20018DataRelationships {
            group: None,
            moderator: None,
            user: None,
        }
