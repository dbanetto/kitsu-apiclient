...
pub struct LibraryEntryLogsAttributes {
    ...
    #[serde(rename = "actionPerformed", skip_serializing_if = "Option::is_none")]
    pub action_performed: Option<crate::models::ActionPerformed>,
    #[serde(rename = "syncStatus", skip_serializing_if = "Option::is_none")]
    pub sync_status: Option<crate::models::SyncStatus>,
    #[serde(rename = "errorMessage", skip_serializing_if = "Option::is_none")]
    pub error_message: Option<String>,
}

impl LibraryEntryLogsAttributes {
    pub fn new() -> LibraryEntryLogsAttributes {
