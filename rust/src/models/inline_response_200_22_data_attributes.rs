...
pub struct InlineResponse20022DataAttributes {
...
impl InlineResponse20022DataAttributes {
    pub fn new() -> InlineResponse20022DataAttributes {
        InlineResponse20022DataAttributes {
            created_at: None,
            rank: None,
            unread_count: None,
            updated_at: None,
