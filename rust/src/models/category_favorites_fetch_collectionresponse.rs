...
pub struct CategoryFavoritesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::CategoryFavorites>,
    #[serde(rename = "meta")]
...
impl CategoryFavoritesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::CategoryFavorites>, meta: crate::models::Meta14) -> CategoryFavoritesFetchCollectionresponse {
        CategoryFavoritesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
