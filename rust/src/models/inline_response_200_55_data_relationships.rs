...
pub struct InlineResponse20055DataRelationships {
...
impl InlineResponse20055DataRelationships {
    pub fn new() -> InlineResponse20055DataRelationships {
        InlineResponse20055DataRelationships {
            library_entry: None,
            media: None,
            user: None,
        }
