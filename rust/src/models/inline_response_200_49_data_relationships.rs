...
pub struct InlineResponse20049DataRelationships {
    #[serde(rename = "ama", skip_serializing_if = "Option::is_none")]
    pub ama: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "comments", skip_serializing_if = "Option::is_none")]
    pub comments: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "media", skip_serializing_if = "Option::is_none")]
    pub media: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "postLikes", skip_serializing_if = "Option::is_none")]
    pub post_likes: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "spoiledUnit", skip_serializing_if = "Option::is_none")]
    pub spoiled_unit: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "targetGroup", skip_serializing_if = "Option::is_none")]
    pub target_group: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "targetUser", skip_serializing_if = "Option::is_none")]
    pub target_user: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "uploads", skip_serializing_if = "Option::is_none")]
    pub uploads: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse20049DataRelationships {
    pub fn new() -> InlineResponse20049DataRelationships {
        InlineResponse20049DataRelationships {
            ama: None,
            comments: None,
            media: None,
            post_likes: None,
