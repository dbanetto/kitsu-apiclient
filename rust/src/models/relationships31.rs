...
pub struct Relationships31 {
    #[serde(rename = "animeMediaAttribute", skip_serializing_if = "Option::is_none")]
    pub anime_media_attribute: Option<crate::models::AnimeMediaAttribute>,
    #[serde(rename = "mangaMediaAttribute", skip_serializing_if = "Option::is_none")]
    pub manga_media_attribute: Option<crate::models::MangaMediaAttribute>,
    #[serde(rename = "dramasMediaAttribute", skip_serializing_if = "Option::is_none")]
    pub dramas_media_attribute: Option<crate::models::DramasMediaAttribute>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<crate::models::User>,
}

impl Relationships31 {
    pub fn new() -> Relationships31 {
        Relationships31 {
