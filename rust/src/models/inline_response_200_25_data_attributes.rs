...
pub struct InlineResponse20025DataAttributes {
    /// ISO 8601 date and time
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "explanation", skip_serializing_if = "Option::is_none")]
    pub explanation: Option<String>,
    #[serde(rename = "naughtyId", skip_serializing_if = "Option::is_none")]
    pub naughty_id: Option<f32>,
    #[serde(rename = "naughtyType", skip_serializing_if = "Option::is_none")]
    pub naughty_type: Option<String>,
...
impl InlineResponse20025DataAttributes {
    pub fn new() -> InlineResponse20025DataAttributes {
        InlineResponse20025DataAttributes {
            created_at: None,
            explanation: None,
            naughty_id: None,
            naughty_type: None,
