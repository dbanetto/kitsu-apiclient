...
pub struct InlineResponse2006DataRelationships {
    #[serde(rename = "character", skip_serializing_if = "Option::is_none")]
    pub character: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
    ...
    pub person: Option<crate::models::InlineResponse2001DataRelationshipsAnime>,
}

impl InlineResponse2006DataRelationships {
    pub fn new() -> InlineResponse2006DataRelationships {
