...
pub struct InlineResponse20041Data {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<crate::models::InlineResponse20041DataAttributes>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<crate::models::InlineResponse2001DataLinks>,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<crate::models::InlineResponse20041DataRelationships>,
    #[serde(rename = "type")]
    pub _type: String,
}

impl InlineResponse20041Data {
    pub fn new(id: String, _type: String) -> InlineResponse20041Data {
