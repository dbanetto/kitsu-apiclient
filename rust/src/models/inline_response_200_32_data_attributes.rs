...
pub struct InlineResponse20032DataAttributes {
...
impl InlineResponse20032DataAttributes {
    pub fn new() -> InlineResponse20032DataAttributes {
        InlineResponse20032DataAttributes {
            created_at: None,
            finished_at: None,
            notes: None,
            private: None,
