...
pub struct CommentLikesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::CommentLikes>,
    #[serde(rename = "meta")]
...
impl CommentLikesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::CommentLikes>, meta: crate::models::Meta14) -> CommentLikesFetchCollectionresponse {
        CommentLikesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
