...
pub struct InlineResponse20010DataAttributes {
    ...
    pub image: Option<crate::models::InlineResponse20010DataAttributesImage>,
    #[serde(rename = "malId", skip_serializing_if = "Option::is_none")]
    pub mal_id: Option<f32>,
...
impl InlineResponse20010DataAttributes {
    pub fn new() -> InlineResponse20010DataAttributes {
        InlineResponse20010DataAttributes {
            created_at: None,
            description: None,
            image: None,
            mal_id: None,
