...
pub struct EpisodesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Episodes>,
    #[serde(rename = "meta")]
...
impl EpisodesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Episodes>, meta: crate::models::Meta14) -> EpisodesFetchCollectionresponse {
        EpisodesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
