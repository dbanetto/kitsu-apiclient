...
pub struct FavoritesFetchCollectionresponse {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::Favorites>,
    #[serde(rename = "meta")]
...
impl FavoritesFetchCollectionresponse {
    pub fn new(data: Vec<crate::models::Favorites>, meta: crate::models::Meta14) -> FavoritesFetchCollectionresponse {
        FavoritesFetchCollectionresponse {
            data,
            meta,
            links: None,
        }
