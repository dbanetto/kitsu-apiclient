...
pub struct InlineResponse20024DataAttributes {
...
impl InlineResponse20024DataAttributes {
    pub fn new() -> InlineResponse20024DataAttributes {
        InlineResponse20024DataAttributes {
            created_at: None,
            permission: None,
            updated_at: None,
        }
