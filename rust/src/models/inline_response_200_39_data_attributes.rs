...
pub struct InlineResponse20039DataAttributes {
    #[serde(rename = "abbreviatedTitles", skip_serializing_if = "Option::is_none")]
    pub abbreviated_titles: Option<crate::models::AnyType>,
    #[serde(rename = "ageRating", skip_serializing_if = "Option::is_none")]
    pub age_rating: Option<AgeRating>,
    #[serde(rename = "ageRatingGuide", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "chapterCount", skip_serializing_if = "Option::is_none")]
    pub chapter_count: Option<f32>,
    ...
    /// Deprecated
    #[serde(rename = "coverImageTopOffset", skip_serializing_if = "Option::is_none")]
    pub cover_image_top_offset: Option<f32>,
    ...
    #[serde(rename = "mangaType", skip_serializing_if = "Option::is_none")]
    pub manga_type: Option<MangaType>,
    #[serde(rename = "popularityRank", skip_serializing_if = "Option::is_none")]
    pub popularity_rank: Option<f32>,
    #[serde(rename = "posterImage", skip_serializing_if = "Option::is_none")]
    pub poster_image: Option<crate::models::InlineResponse2004DataAttributesPosterImage>,
    #[serde(rename = "ratingFrequencies", skip_serializing_if = "Option::is_none")]
    pub rating_frequencies: Option<crate::models::InlineResponse2004DataAttributesRatingFrequencies>,
    #[serde(rename = "ratingRank", skip_serializing_if = "Option::is_none")]
    pub rating_rank: Option<f32>,
    #[serde(rename = "serialization", skip_serializing_if = "Option::is_none")]
    ...
    pub titles: Option<crate::models::InlineResponse2004DataAttributesTitles>,
    /// ISO 8601 of last modification
    #[serde(rename = "updatedAt", skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
    #[serde(rename = "userCount", skip_serializing_if = "Option::is_none")]
    pub user_count: Option<f32>,
    #[serde(rename = "volumeCount", skip_serializing_if = "Option::is_none")]
    pub volume_count: Option<f32>,
}

impl InlineResponse20039DataAttributes {
    pub fn new() -> InlineResponse20039DataAttributes {
        InlineResponse20039DataAttributes {
